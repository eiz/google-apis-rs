...
impl<'a, > BigQueryDataTransfer<> {
    ...
    /// It defaults to `https://bigquerydatatransfer.googleapis.com/`.
    ///
...
/// Returns true if valid credentials exist for the given data source and requesting user.
///
/// A builder for the *dataSources.checkValidCreds* method supported by a *project* resource.
...
/// # extern crate hyper_rustls;
/// # extern crate google_bigquerydatatransfer1 as bigquerydatatransfer1;
/// use bigquerydatatransfer1::api::CheckValidCredsRequest;
/// # async fn dox() {
/// # use std::default::Default;
/// # use bigquerydatatransfer1::{BigQueryDataTransfer, oauth2, hyper, hyper_rustls};
/// 
...
/// // into the respective structure. Some of the parts shown here might not be applicable !
/// // Values shown here are possibly random and not representative !
/// let mut req = CheckValidCredsRequest::default();
/// 
/// // You can configure optional parameters by calling the respective setters at will, and
/// // execute the final call using `doit()`.
/// // Values shown here are possibly random and not representative !
/// let result = hub.projects().data_sources_check_valid_creds(req, "name")
///              .doit().await;
/// # }
/// ```
...
impl<'a> ProjectDataSourceCheckValidCredCall<'a> {
    ...
    pub async fn doit(mut self) -> client::Result<(hyper::Response<hyper::body::Body>, CheckValidCredsResponse)> {
        ...
        dlg.begin(client::MethodInfo { id: "bigquerydatatransfer.projects.dataSources.checkValidCreds",
        ...
        let mut url = self.hub._base_url.clone() + "v1/{+name}:checkValidCreds";
...
/// Retrieves a supported data source and returns its settings.
///
/// A builder for the *dataSources.get* method supported by a *project* resource.
/// It is not used directly, but through a `ProjectMethods` instance.
///
/// # Example
///
...
/// // execute the final call using `doit()`.
/// // Values shown here are possibly random and not representative !
/// let result = hub.projects().data_sources_get("name")
///              .doit().await;
/// # }
/// ```
...
impl<'a> ProjectDataSourceGetCall<'a> {
    ...
    pub async fn doit(mut self) -> client::Result<(hyper::Response<hyper::body::Body>, DataSource)> {
        ...
        dlg.begin(client::MethodInfo { id: "bigquerydatatransfer.projects.dataSources.get",
...
/// Lists supported data sources and returns their settings.
///
/// A builder for the *dataSources.list* method supported by a *project* resource.
/// It is not used directly, but through a `ProjectMethods` instance.
///
/// # Example
///
...
impl<'a> ProjectDataSourceListCall<'a> {
    ...
    pub async fn doit(mut self) -> client::Result<(hyper::Response<hyper::body::Body>, ListDataSourcesResponse)> {
        ...
        dlg.begin(client::MethodInfo { id: "bigquerydatatransfer.projects.dataSources.list",
                               http_method: hyper::Method::GET });
...
/// Returns true if valid credentials exist for the given data source and requesting user.
///
/// A builder for the *locations.dataSources.checkValidCreds* method supported by a *project* resource.
/// It is not used directly, but through a `ProjectMethods` instance.
///
/// # Example
///
...
/// // execute the final call using `doit()`.
/// // Values shown here are possibly random and not representative !
/// let result = hub.projects().locations_data_sources_check_valid_creds(req, "name")
///              .doit().await;
/// # }
/// ```
...
impl<'a> ProjectLocationDataSourceCheckValidCredCall<'a> {
    ...
    pub async fn doit(mut self) -> client::Result<(hyper::Response<hyper::body::Body>, CheckValidCredsResponse)> {
        ...
        dlg.begin(client::MethodInfo { id: "bigquerydatatransfer.projects.locations.dataSources.checkValidCreds",
                               http_method: hyper::Method::POST });
        let mut params: Vec<(&str, String)> = Vec::with_capacity(4 + self._additional_params.len());
        params.push(("name", self._name.to_string()));
        for &field in ["alt", "name"].iter() {
...
/// Retrieves a supported data source and returns its settings.
///
/// A builder for the *locations.dataSources.get* method supported by a *project* resource.
/// It is not used directly, but through a `ProjectMethods` instance.
///
/// # Example
///
...
/// // execute the final call using `doit()`.
/// // Values shown here are possibly random and not representative !
/// let result = hub.projects().locations_data_sources_get("name")
///              .doit().await;
/// # }
/// ```
...
impl<'a> ProjectLocationDataSourceGetCall<'a> {
    ...
    pub async fn doit(mut self) -> client::Result<(hyper::Response<hyper::body::Body>, DataSource)> {
        ...
        dlg.begin(client::MethodInfo { id: "bigquerydatatransfer.projects.locations.dataSources.get",
                               http_method: hyper::Method::GET });
        let mut params: Vec<(&str, String)> = Vec::with_capacity(3 + self._additional_params.len());
        params.push(("name", self._name.to_string()));
        for &field in ["alt", "name"].iter() {
...
/// Lists supported data sources and returns their settings.
///
/// A builder for the *locations.dataSources.list* method supported by a *project* resource.
/// It is not used directly, but through a `ProjectMethods` instance.
///
/// # Example
///
...
impl<'a> ProjectLocationDataSourceListCall<'a> {
    ...
    pub async fn doit(mut self) -> client::Result<(hyper::Response<hyper::body::Body>, ListDataSourcesResponse)> {
        ...
        dlg.begin(client::MethodInfo { id: "bigquerydatatransfer.projects.locations.dataSources.list",
                               http_method: hyper::Method::GET });
        let mut params: Vec<(&str, String)> = Vec::with_capacity(5 + self._additional_params.len());
        params.push(("parent", self._parent.to_string()));
        if let Some(value) = self._page_token {
...
/// Returns log messages for the transfer run.
///
/// A builder for the *locations.transferConfigs.runs.transferLogs.list* method supported by a *project* resource.
/// It is not used directly, but through a `ProjectMethods` instance.
///
/// # Example
///
...
impl<'a> ProjectLocationTransferConfigRunTransferLogListCall<'a> {
    ...
    /// Perform the operation you have build so far.
    pub async fn doit(mut self) -> client::Result<(hyper::Response<hyper::body::Body>, ListTransferLogsResponse)> {
        use url::percent_encoding::{percent_encode, DEFAULT_ENCODE_SET};
        use std::io::{Read, Seek};
        use hyper::header::{CONTENT_TYPE, CONTENT_LENGTH, AUTHORIZATION, USER_AGENT, LOCATION};
        use client::ToParts;
        ...
        dlg.begin(client::MethodInfo { id: "bigquerydatatransfer.projects.locations.transferConfigs.runs.transferLogs.list",
                               http_method: hyper::Method::GET });
        ...
        if self._message_types.len() > 0 {
            for f in self._message_types.iter() {
                params.push(("messageTypes", f.to_string()));
            }
        }
        for &field in ["alt", "parent", "pageToken", "pageSize", "messageTypes"].iter() {
            if self._additional_params.contains_key(field) {
                dlg.finished(false);
                return Err(client::Error::FieldClash(field));
            }
...
/// Deletes the specified transfer run.
///
/// A builder for the *locations.transferConfigs.runs.delete* method supported by a *project* resource.
/// It is not used directly, but through a `ProjectMethods` instance.
///
/// # Example
///
...
/// // execute the final call using `doit()`.
/// // Values shown here are possibly random and not representative !
/// let result = hub.projects().locations_transfer_configs_runs_delete("name")
///              .doit().await;
/// # }
/// ```
...
impl<'a> ProjectLocationTransferConfigRunDeleteCall<'a> {
    ...
    pub async fn doit(mut self) -> client::Result<(hyper::Response<hyper::body::Body>, Empty)> {
        ...
        dlg.begin(client::MethodInfo { id: "bigquerydatatransfer.projects.locations.transferConfigs.runs.delete",
...
/// Returns information about the particular transfer run.
///
/// A builder for the *locations.transferConfigs.runs.get* method supported by a *project* resource.
/// It is not used directly, but through a `ProjectMethods` instance.
///
/// # Example
///
...
/// // execute the final call using `doit()`.
/// // Values shown here are possibly random and not representative !
/// let result = hub.projects().locations_transfer_configs_runs_get("name")
///              .doit().await;
/// # }
/// ```
...
impl<'a> ProjectLocationTransferConfigRunGetCall<'a> {
    ...
    /// Perform the operation you have build so far.
    pub async fn doit(mut self) -> client::Result<(hyper::Response<hyper::body::Body>, TransferRun)> {
        use url::percent_encoding::{percent_encode, DEFAULT_ENCODE_SET};
        use std::io::{Read, Seek};
        use hyper::header::{CONTENT_TYPE, CONTENT_LENGTH, AUTHORIZATION, USER_AGENT, LOCATION};
        use client::ToParts;
        ...
        dlg.begin(client::MethodInfo { id: "bigquerydatatransfer.projects.locations.transferConfigs.runs.get",
                               http_method: hyper::Method::GET });
        let mut params: Vec<(&str, String)> = Vec::with_capacity(3 + self._additional_params.len());
        params.push(("name", self._name.to_string()));
        for &field in ["alt", "name"].iter() {
...
/// Returns information about running and completed transfer runs.
///
/// A builder for the *locations.transferConfigs.runs.list* method supported by a *project* resource.
/// It is not used directly, but through a `ProjectMethods` instance.
///
/// # Example
///
...
impl<'a> ProjectLocationTransferConfigRunListCall<'a> {
    ...
    /// Perform the operation you have build so far.
    pub async fn doit(mut self) -> client::Result<(hyper::Response<hyper::body::Body>, ListTransferRunsResponse)> {
        use url::percent_encoding::{percent_encode, DEFAULT_ENCODE_SET};
        use std::io::{Read, Seek};
        use hyper::header::{CONTENT_TYPE, CONTENT_LENGTH, AUTHORIZATION, USER_AGENT, LOCATION};
        use client::ToParts;
        ...
        dlg.begin(client::MethodInfo { id: "bigquerydatatransfer.projects.locations.transferConfigs.runs.list",
                               http_method: hyper::Method::GET });
        ...
        if let Some(value) = self._run_attempt {
            params.push(("runAttempt", value.to_string()));
        }
        if let Some(value) = self._page_token {
            params.push(("pageToken", value.to_string()));
        }
        ...
        for &field in ["alt", "parent", "states", "runAttempt", "pageToken", "pageSize"].iter() {
            if self._additional_params.contains_key(field) {
                dlg.finished(false);
                return Err(client::Error::FieldClash(field));
            }
...
/// Creates a new data transfer configuration.
///
/// A builder for the *locations.transferConfigs.create* method supported by a *project* resource.
/// It is not used directly, but through a `ProjectMethods` instance.
///
/// # Example
///
...
impl<'a> ProjectLocationTransferConfigCreateCall<'a> {
    ...
    /// Perform the operation you have build so far.
    pub async fn doit(mut self) -> client::Result<(hyper::Response<hyper::body::Body>, TransferConfig)> {
        use url::percent_encoding::{percent_encode, DEFAULT_ENCODE_SET};
        use std::io::{Read, Seek};
        use hyper::header::{CONTENT_TYPE, CONTENT_LENGTH, AUTHORIZATION, USER_AGENT, LOCATION};
        use client::ToParts;
        ...
        dlg.begin(client::MethodInfo { id: "bigquerydatatransfer.projects.locations.transferConfigs.create",
                               http_method: hyper::Method::POST });
        let mut params: Vec<(&str, String)> = Vec::with_capacity(7 + self._additional_params.len());
        params.push(("parent", self._parent.to_string()));
...
/// Deletes a data transfer configuration, including any associated transfer runs and logs.
///
/// A builder for the *locations.transferConfigs.delete* method supported by a *project* resource.
/// It is not used directly, but through a `ProjectMethods` instance.
///
/// # Example
///
...
/// // execute the final call using `doit()`.
/// // Values shown here are possibly random and not representative !
/// let result = hub.projects().locations_transfer_configs_delete("name")
///              .doit().await;
/// # }
/// ```
...
impl<'a> ProjectLocationTransferConfigDeleteCall<'a> {
    ...
    pub async fn doit(mut self) -> client::Result<(hyper::Response<hyper::body::Body>, Empty)> {
        ...
        dlg.begin(client::MethodInfo { id: "bigquerydatatransfer.projects.locations.transferConfigs.delete",
                               http_method: hyper::Method::DELETE });
        let mut params: Vec<(&str, String)> = Vec::with_capacity(3 + self._additional_params.len());
        params.push(("name", self._name.to_string()));
        for &field in ["alt", "name"].iter() {
...
/// Returns information about a data transfer config.
///
/// A builder for the *locations.transferConfigs.get* method supported by a *project* resource.
/// It is not used directly, but through a `ProjectMethods` instance.
///
/// # Example
///
...
/// // execute the final call using `doit()`.
/// // Values shown here are possibly random and not representative !
/// let result = hub.projects().locations_transfer_configs_get("name")
///              .doit().await;
/// # }
/// ```
...
impl<'a> ProjectLocationTransferConfigGetCall<'a> {
    ...
    pub async fn doit(mut self) -> client::Result<(hyper::Response<hyper::body::Body>, TransferConfig)> {
        ...
        dlg.begin(client::MethodInfo { id: "bigquerydatatransfer.projects.locations.transferConfigs.get",
                               http_method: hyper::Method::GET });
        let mut params: Vec<(&str, String)> = Vec::with_capacity(3 + self._additional_params.len());
        params.push(("name", self._name.to_string()));
        for &field in ["alt", "name"].iter() {
...
/// Returns information about all transfer configs owned by a project in the specified location.
///
/// A builder for the *locations.transferConfigs.list* method supported by a *project* resource.
/// It is not used directly, but through a `ProjectMethods` instance.
///
/// # Example
///
...
impl<'a> ProjectLocationTransferConfigListCall<'a> {
    ...
    /// Perform the operation you have build so far.
    pub async fn doit(mut self) -> client::Result<(hyper::Response<hyper::body::Body>, ListTransferConfigsResponse)> {
        use url::percent_encoding::{percent_encode, DEFAULT_ENCODE_SET};
        use std::io::{Read, Seek};
        use hyper::header::{CONTENT_TYPE, CONTENT_LENGTH, AUTHORIZATION, USER_AGENT, LOCATION};
        use client::ToParts;
        ...
        dlg.begin(client::MethodInfo { id: "bigquerydatatransfer.projects.locations.transferConfigs.list",
                               http_method: hyper::Method::GET });
        let mut params: Vec<(&str, String)> = Vec::with_capacity(6 + self._additional_params.len());
        params.push(("parent", self._parent.to_string()));
        if let Some(value) = self._page_token {
        ...
        if self._data_source_ids.len() > 0 {
            for f in self._data_source_ids.iter() {
                params.push(("dataSourceIds", f.to_string()));
            }
        }
        for &field in ["alt", "parent", "pageToken", "pageSize", "dataSourceIds"].iter() {
            if self._additional_params.contains_key(field) {
                dlg.finished(false);
                return Err(client::Error::FieldClash(field));
            }
...
/// Updates a data transfer configuration. All fields must be set, even if they are not updated.
///
/// A builder for the *locations.transferConfigs.patch* method supported by a *project* resource.
/// It is not used directly, but through a `ProjectMethods` instance.
///
/// # Example
///
...
impl<'a> ProjectLocationTransferConfigPatchCall<'a> {
    ...
    pub async fn doit(mut self) -> client::Result<(hyper::Response<hyper::body::Body>, TransferConfig)> {
        ...
        dlg.begin(client::MethodInfo { id: "bigquerydatatransfer.projects.locations.transferConfigs.patch",
...
/// Creates transfer runs for a time range [start_time, end_time]. For each date - or whatever granularity the data source supports - in the range, one transfer run is created. Note that runs are created per UTC time in the time range. DEPRECATED: use StartManualTransferRuns instead.
///
/// A builder for the *locations.transferConfigs.scheduleRuns* method supported by a *project* resource.
/// It is not used directly, but through a `ProjectMethods` instance.
///
/// # Example
///
...
/// # extern crate hyper_rustls;
/// # extern crate google_bigquerydatatransfer1 as bigquerydatatransfer1;
/// use bigquerydatatransfer1::api::ScheduleTransferRunsRequest;
/// # async fn dox() {
/// # use std::default::Default;
/// # use bigquerydatatransfer1::{BigQueryDataTransfer, oauth2, hyper, hyper_rustls};
/// 
...
/// // into the respective structure. Some of the parts shown here might not be applicable !
/// // Values shown here are possibly random and not representative !
/// let mut req = ScheduleTransferRunsRequest::default();
/// 
/// // You can configure optional parameters by calling the respective setters at will, and
/// // execute the final call using `doit()`.
/// // Values shown here are possibly random and not representative !
/// let result = hub.projects().locations_transfer_configs_schedule_runs(req, "parent")
///              .doit().await;
/// # }
/// ```
...
impl<'a> ProjectLocationTransferConfigScheduleRunCall<'a> {
    ...
    /// Perform the operation you have build so far.
    pub async fn doit(mut self) -> client::Result<(hyper::Response<hyper::body::Body>, ScheduleTransferRunsResponse)> {
        use url::percent_encoding::{percent_encode, DEFAULT_ENCODE_SET};
        use std::io::{Read, Seek};
        use hyper::header::{CONTENT_TYPE, CONTENT_LENGTH, AUTHORIZATION, USER_AGENT, LOCATION};
        use client::ToParts;
        ...
        dlg.begin(client::MethodInfo { id: "bigquerydatatransfer.projects.locations.transferConfigs.scheduleRuns",
                               http_method: hyper::Method::POST });
        let mut params: Vec<(&str, String)> = Vec::with_capacity(4 + self._additional_params.len());
        params.push(("parent", self._parent.to_string()));
        ...
        let mut url = self.hub._base_url.clone() + "v1/{+parent}:scheduleRuns";
        if self._scopes.len() == 0 {
            self._scopes.insert(Scope::Bigquery.as_ref().to_string(), ());
        }
...
/// Start manual transfer runs to be executed now with schedule_time equal to current time. The transfer runs can be created for a time range where the run_time is between start_time (inclusive) and end_time (exclusive), or for a specific run_time.
///
/// A builder for the *locations.transferConfigs.startManualRuns* method supported by a *project* resource.
/// It is not used directly, but through a `ProjectMethods` instance.
///
/// # Example
///
...
/// # extern crate hyper_rustls;
/// # extern crate google_bigquerydatatransfer1 as bigquerydatatransfer1;
/// use bigquerydatatransfer1::api::StartManualTransferRunsRequest;
/// # async fn dox() {
/// # use std::default::Default;
/// # use bigquerydatatransfer1::{BigQueryDataTransfer, oauth2, hyper, hyper_rustls};
/// 
...
/// // into the respective structure. Some of the parts shown here might not be applicable !
/// // Values shown here are possibly random and not representative !
/// let mut req = StartManualTransferRunsRequest::default();
/// 
/// // You can configure optional parameters by calling the respective setters at will, and
/// // execute the final call using `doit()`.
/// // Values shown here are possibly random and not representative !
/// let result = hub.projects().locations_transfer_configs_start_manual_runs(req, "parent")
///              .doit().await;
/// # }
/// ```
...
impl<'a> ProjectLocationTransferConfigStartManualRunCall<'a> {
    ...
    /// Perform the operation you have build so far.
    pub async fn doit(mut self) -> client::Result<(hyper::Response<hyper::body::Body>, StartManualTransferRunsResponse)> {
        use url::percent_encoding::{percent_encode, DEFAULT_ENCODE_SET};
        use std::io::{Read, Seek};
        use hyper::header::{CONTENT_TYPE, CONTENT_LENGTH, AUTHORIZATION, USER_AGENT, LOCATION};
        use client::ToParts;
        ...
        dlg.begin(client::MethodInfo { id: "bigquerydatatransfer.projects.locations.transferConfigs.startManualRuns",
                               http_method: hyper::Method::POST });
        let mut params: Vec<(&str, String)> = Vec::with_capacity(4 + self._additional_params.len());
        params.push(("parent", self._parent.to_string()));
        for &field in ["alt", "parent"].iter() {
        ...
        let mut url = self.hub._base_url.clone() + "v1/{+parent}:startManualRuns";
        if self._scopes.len() == 0 {
            self._scopes.insert(Scope::Bigquery.as_ref().to_string(), ());
        }
...
/// Enroll data sources in a user project. This allows users to create transfer configurations for these data sources. They will also appear in the ListDataSources RPC and as such, will appear in the BigQuery UI 'https://bigquery.cloud.google.com' (and the documents can be found at https://cloud.google.com/bigquery/bigquery-web-ui and https://cloud.google.com/bigquery/docs/working-with-transfers).
///
/// A builder for the *locations.enrollDataSources* method supported by a *project* resource.
/// It is not used directly, but through a `ProjectMethods` instance.
///
/// # Example
///
...
impl<'a> ProjectLocationEnrollDataSourceCall<'a> {
    ...
    pub async fn doit(mut self) -> client::Result<(hyper::Response<hyper::body::Body>, Empty)> {
        ...
        dlg.begin(client::MethodInfo { id: "bigquerydatatransfer.projects.locations.enrollDataSources",
                               http_method: hyper::Method::POST });
        let mut params: Vec<(&str, String)> = Vec::with_capacity(4 + self._additional_params.len());
        params.push(("name", self._name.to_string()));
        for &field in ["alt", "name"].iter() {
        ...
        let mut url = self.hub._base_url.clone() + "v1/{+name}:enrollDataSources";
        if self._scopes.len() == 0 {
            self._scopes.insert(Scope::Bigquery.as_ref().to_string(), ());
        }
...
impl<'a> ProjectLocationGetCall<'a> {
    ...
    pub async fn doit(mut self) -> client::Result<(hyper::Response<hyper::body::Body>, Location)> {
        ...
        dlg.begin(client::MethodInfo { id: "bigquerydatatransfer.projects.locations.get",
                               http_method: hyper::Method::GET });
        let mut params: Vec<(&str, String)> = Vec::with_capacity(3 + self._additional_params.len());
        params.push(("name", self._name.to_string()));
        for &field in ["alt", "name"].iter() {
...
impl<'a> ProjectLocationListCall<'a> {
    ...
    pub async fn doit(mut self) -> client::Result<(hyper::Response<hyper::body::Body>, ListLocationsResponse)> {
        ...
        dlg.begin(client::MethodInfo { id: "bigquerydatatransfer.projects.locations.list",
                               http_method: hyper::Method::GET });
        let mut params: Vec<(&str, String)> = Vec::with_capacity(6 + self._additional_params.len());
        params.push(("name", self._name.to_string()));
        if let Some(value) = self._page_token {
...
impl<'a> ProjectTransferConfigRunTransferLogListCall<'a> {
    ...
    pub async fn doit(mut self) -> client::Result<(hyper::Response<hyper::body::Body>, ListTransferLogsResponse)> {
        ...
        dlg.begin(client::MethodInfo { id: "bigquerydatatransfer.projects.transferConfigs.runs.transferLogs.list",
                               http_method: hyper::Method::GET });
        let mut params: Vec<(&str, String)> = Vec::with_capacity(6 + self._additional_params.len());
        params.push(("parent", self._parent.to_string()));
        if let Some(value) = self._page_token {
...
/// Deletes the specified transfer run.
///
/// A builder for the *transferConfigs.runs.delete* method supported by a *project* resource.
/// It is not used directly, but through a `ProjectMethods` instance.
///
/// # Example
///
...
/// // execute the final call using `doit()`.
/// // Values shown here are possibly random and not representative !
/// let result = hub.projects().transfer_configs_runs_delete("name")
///              .doit().await;
/// # }
/// ```
...
impl<'a> ProjectTransferConfigRunDeleteCall<'a> {
    ...
    pub async fn doit(mut self) -> client::Result<(hyper::Response<hyper::body::Body>, Empty)> {
        ...
        dlg.begin(client::MethodInfo { id: "bigquerydatatransfer.projects.transferConfigs.runs.delete",
                               http_method: hyper::Method::DELETE });
        let mut params: Vec<(&str, String)> = Vec::with_capacity(3 + self._additional_params.len());
        params.push(("name", self._name.to_string()));
        for &field in ["alt", "name"].iter() {
...
/// Returns information about the particular transfer run.
///
/// A builder for the *transferConfigs.runs.get* method supported by a *project* resource.
/// It is not used directly, but through a `ProjectMethods` instance.
///
/// # Example
///
...
/// // execute the final call using `doit()`.
/// // Values shown here are possibly random and not representative !
/// let result = hub.projects().transfer_configs_runs_get("name")
///              .doit().await;
/// # }
/// ```
...
impl<'a> ProjectTransferConfigRunGetCall<'a> {
    ...
    pub async fn doit(mut self) -> client::Result<(hyper::Response<hyper::body::Body>, TransferRun)> {
        ...
        dlg.begin(client::MethodInfo { id: "bigquerydatatransfer.projects.transferConfigs.runs.get",
                               http_method: hyper::Method::GET });
        let mut params: Vec<(&str, String)> = Vec::with_capacity(3 + self._additional_params.len());
        params.push(("name", self._name.to_string()));
        for &field in ["alt", "name"].iter() {
...
/// Returns information about running and completed transfer runs.
///
/// A builder for the *transferConfigs.runs.list* method supported by a *project* resource.
/// It is not used directly, but through a `ProjectMethods` instance.
///
/// # Example
///
...
impl<'a> ProjectTransferConfigRunListCall<'a> {
    ...
    pub async fn doit(mut self) -> client::Result<(hyper::Response<hyper::body::Body>, ListTransferRunsResponse)> {
        ...
        dlg.begin(client::MethodInfo { id: "bigquerydatatransfer.projects.transferConfigs.runs.list",
                               http_method: hyper::Method::GET });
        let mut params: Vec<(&str, String)> = Vec::with_capacity(7 + self._additional_params.len());
        params.push(("parent", self._parent.to_string()));
        if self._states.len() > 0 {
...
/// Creates a new data transfer configuration.
///
/// A builder for the *transferConfigs.create* method supported by a *project* resource.
/// It is not used directly, but through a `ProjectMethods` instance.
///
/// # Example
///
...
impl<'a> ProjectTransferConfigCreateCall<'a> {
    ...
    pub async fn doit(mut self) -> client::Result<(hyper::Response<hyper::body::Body>, TransferConfig)> {
        ...
        dlg.begin(client::MethodInfo { id: "bigquerydatatransfer.projects.transferConfigs.create",
                               http_method: hyper::Method::POST });
        let mut params: Vec<(&str, String)> = Vec::with_capacity(7 + self._additional_params.len());
        params.push(("parent", self._parent.to_string()));
        if let Some(value) = self._version_info {
...
/// Deletes a data transfer configuration, including any associated transfer runs and logs.
///
/// A builder for the *transferConfigs.delete* method supported by a *project* resource.
/// It is not used directly, but through a `ProjectMethods` instance.
///
/// # Example
///
...
/// // execute the final call using `doit()`.
/// // Values shown here are possibly random and not representative !
/// let result = hub.projects().transfer_configs_delete("name")
///              .doit().await;
/// # }
/// ```
...
impl<'a> ProjectTransferConfigDeleteCall<'a> {
    ...
    pub async fn doit(mut self) -> client::Result<(hyper::Response<hyper::body::Body>, Empty)> {
        ...
        dlg.begin(client::MethodInfo { id: "bigquerydatatransfer.projects.transferConfigs.delete",
                               http_method: hyper::Method::DELETE });
        let mut params: Vec<(&str, String)> = Vec::with_capacity(3 + self._additional_params.len());
        params.push(("name", self._name.to_string()));
        for &field in ["alt", "name"].iter() {
...
/// Returns information about a data transfer config.
///
/// A builder for the *transferConfigs.get* method supported by a *project* resource.
/// It is not used directly, but through a `ProjectMethods` instance.
///
/// # Example
///
...
/// // execute the final call using `doit()`.
/// // Values shown here are possibly random and not representative !
/// let result = hub.projects().transfer_configs_get("name")
///              .doit().await;
/// # }
/// ```
...
impl<'a> ProjectTransferConfigGetCall<'a> {
    ...
    pub async fn doit(mut self) -> client::Result<(hyper::Response<hyper::body::Body>, TransferConfig)> {
        ...
        dlg.begin(client::MethodInfo { id: "bigquerydatatransfer.projects.transferConfigs.get",
                               http_method: hyper::Method::GET });
        let mut params: Vec<(&str, String)> = Vec::with_capacity(3 + self._additional_params.len());
        params.push(("name", self._name.to_string()));
        for &field in ["alt", "name"].iter() {
...
/// Returns information about all transfer configs owned by a project in the specified location.
///
/// A builder for the *transferConfigs.list* method supported by a *project* resource.
/// It is not used directly, but through a `ProjectMethods` instance.
///
/// # Example
///
...
impl<'a> ProjectTransferConfigListCall<'a> {
    ...
    pub async fn doit(mut self) -> client::Result<(hyper::Response<hyper::body::Body>, ListTransferConfigsResponse)> {
        ...
        dlg.begin(client::MethodInfo { id: "bigquerydatatransfer.projects.transferConfigs.list",
                               http_method: hyper::Method::GET });
        let mut params: Vec<(&str, String)> = Vec::with_capacity(6 + self._additional_params.len());
        params.push(("parent", self._parent.to_string()));
        if let Some(value) = self._page_token {
...
/// Updates a data transfer configuration. All fields must be set, even if they are not updated.
///
/// A builder for the *transferConfigs.patch* method supported by a *project* resource.
/// It is not used directly, but through a `ProjectMethods` instance.
///
/// # Example
///
...
impl<'a> ProjectTransferConfigPatchCall<'a> {
    ...
    pub async fn doit(mut self) -> client::Result<(hyper::Response<hyper::body::Body>, TransferConfig)> {
        ...
        dlg.begin(client::MethodInfo { id: "bigquerydatatransfer.projects.transferConfigs.patch",
                               http_method: hyper::Method::PATCH });
        let mut params: Vec<(&str, String)> = Vec::with_capacity(8 + self._additional_params.len());
        params.push(("name", self._name.to_string()));
        if let Some(value) = self._version_info {
...
/// Creates transfer runs for a time range [start_time, end_time]. For each date - or whatever granularity the data source supports - in the range, one transfer run is created. Note that runs are created per UTC time in the time range. DEPRECATED: use StartManualTransferRuns instead.
///
/// A builder for the *transferConfigs.scheduleRuns* method supported by a *project* resource.
/// It is not used directly, but through a `ProjectMethods` instance.
///
/// # Example
///
...
/// // execute the final call using `doit()`.
/// // Values shown here are possibly random and not representative !
/// let result = hub.projects().transfer_configs_schedule_runs(req, "parent")
///              .doit().await;
/// # }
/// ```
...
impl<'a> ProjectTransferConfigScheduleRunCall<'a> {
    ...
    pub async fn doit(mut self) -> client::Result<(hyper::Response<hyper::body::Body>, ScheduleTransferRunsResponse)> {
        ...
        dlg.begin(client::MethodInfo { id: "bigquerydatatransfer.projects.transferConfigs.scheduleRuns",
                               http_method: hyper::Method::POST });
        let mut params: Vec<(&str, String)> = Vec::with_capacity(4 + self._additional_params.len());
        params.push(("parent", self._parent.to_string()));
        for &field in ["alt", "parent"].iter() {
...
/// Start manual transfer runs to be executed now with schedule_time equal to current time. The transfer runs can be created for a time range where the run_time is between start_time (inclusive) and end_time (exclusive), or for a specific run_time.
///
/// A builder for the *transferConfigs.startManualRuns* method supported by a *project* resource.
/// It is not used directly, but through a `ProjectMethods` instance.
///
/// # Example
///
...
/// // execute the final call using `doit()`.
/// // Values shown here are possibly random and not representative !
/// let result = hub.projects().transfer_configs_start_manual_runs(req, "parent")
///              .doit().await;
/// # }
/// ```
...
impl<'a> ProjectTransferConfigStartManualRunCall<'a> {
    ...
    pub async fn doit(mut self) -> client::Result<(hyper::Response<hyper::body::Body>, StartManualTransferRunsResponse)> {
        ...
        dlg.begin(client::MethodInfo { id: "bigquerydatatransfer.projects.transferConfigs.startManualRuns",
                               http_method: hyper::Method::POST });
        let mut params: Vec<(&str, String)> = Vec::with_capacity(4 + self._additional_params.len());
        params.push(("parent", self._parent.to_string()));
        for &field in ["alt", "parent"].iter() {
...
/// Enroll data sources in a user project. This allows users to create transfer configurations for these data sources. They will also appear in the ListDataSources RPC and as such, will appear in the BigQuery UI 'https://bigquery.cloud.google.com' (and the documents can be found at https://cloud.google.com/bigquery/bigquery-web-ui and https://cloud.google.com/bigquery/docs/working-with-transfers).
///
/// A builder for the *enrollDataSources* method supported by a *project* resource.
/// It is not used directly, but through a `ProjectMethods` instance.
///
/// # Example
///
...
/// // execute the final call using `doit()`.
/// // Values shown here are possibly random and not representative !
/// let result = hub.projects().enroll_data_sources(req, "name")
///              .doit().await;
/// # }
/// ```
...
impl<'a> ProjectEnrollDataSourceCall<'a> {
    ...
    pub async fn doit(mut self) -> client::Result<(hyper::Response<hyper::body::Body>, Empty)> {
        ...
        dlg.begin(client::MethodInfo { id: "bigquerydatatransfer.projects.enrollDataSources",
                               http_method: hyper::Method::POST });
        let mut params: Vec<(&str, String)> = Vec::with_capacity(4 + self._additional_params.len());
        params.push(("name", self._name.to_string()));
        for &field in ["alt", "name"].iter() {
