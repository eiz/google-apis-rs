...
impl<'a> ProjectLocationInstanceSnapshotCreateCall<'a> {
    ...
    pub async fn doit(mut self) -> client::Result<(hyper::Response<hyper::body::Body>, Operation)> {
        ...
        let mut url = self.hub._base_url.clone() + "v1/{+parent}/snapshots";
        if self._scopes.len() == 0 {
            self._scopes.insert(Scope::CloudPlatform.as_ref().to_string(), ());
        }
...
/// # extern crate hyper_rustls;
/// # extern crate google_file1 as file1;
/// use file1::api::RestoreInstanceRequest;
/// # async fn dox() {
/// # use std::default::Default;
/// # use file1::{CloudFilestore, oauth2, hyper, hyper_rustls};
/// 
...
/// # extern crate hyper_rustls;
/// # extern crate google_file1 as file1;
/// use file1::api::CancelOperationRequest;
/// # async fn dox() {
/// # use std::default::Default;
/// # use file1::{CloudFilestore, oauth2, hyper, hyper_rustls};
/// 
