...
impl<'a> AccessPolicyAccessLevelCreateCall<'a> {
    ...
    pub async fn doit(mut self) -> client::Result<(hyper::Response<hyper::body::Body>, Operation)> {
        ...
        let mut url = self.hub._base_url.clone() + "v1beta/{+parent}/accessLevels";
...
/// # extern crate hyper_rustls;
/// # extern crate google_accesscontextmanager1_beta as accesscontextmanager1_beta;
/// use accesscontextmanager1_beta::api::ServicePerimeter;
/// # async fn dox() {
/// # use std::default::Default;
/// # use accesscontextmanager1_beta::{AccessContextManager, oauth2, hyper, hyper_rustls};
/// 
...
impl<'a> AccessPolicyServicePerimeterCreateCall<'a> {
    ...
    pub async fn doit(mut self) -> client::Result<(hyper::Response<hyper::body::Body>, Operation)> {
        ...
        let mut url = self.hub._base_url.clone() + "v1beta/{+parent}/servicePerimeters";
        if self._scopes.len() == 0 {
            self._scopes.insert(Scope::CloudPlatform.as_ref().to_string(), ());
        }
...
/// # extern crate hyper_rustls;
/// # extern crate google_accesscontextmanager1_beta as accesscontextmanager1_beta;
/// use accesscontextmanager1_beta::api::AccessPolicy;
/// # async fn dox() {
/// # use std::default::Default;
/// # use accesscontextmanager1_beta::{AccessContextManager, oauth2, hyper, hyper_rustls};
/// 
...
impl<'a> AccessPolicyCreateCall<'a> {
    ...
    pub async fn doit(mut self) -> client::Result<(hyper::Response<hyper::body::Body>, Operation)> {
        ...
        let mut url = self.hub._base_url.clone() + "v1beta/accessPolicies";
        if self._scopes.len() == 0 {
            self._scopes.insert(Scope::CloudPlatform.as_ref().to_string(), ());
        }
