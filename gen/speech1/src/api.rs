...
/// 
/// * [locations custom classes create projects](ProjectLocationCustomClasseCreateCall) (request)
/// 
#[derive(Default, Clone, Debug, Serialize, Deserialize)]
...
/// The list links the activity name, along with information about where it is used (one of *request* and *response*).
/// 
/// * [locations custom classes create projects](ProjectLocationCustomClasseCreateCall) (response)
/// * [locations custom classes get projects](ProjectLocationCustomClasseGetCall) (response)
/// * [locations custom classes patch projects](ProjectLocationCustomClassePatchCall) (request|response)
/// 
#[derive(Default, Clone, Debug, Serialize, Deserialize)]
...
/// The list links the activity name, along with information about where it is used (one of *request* and *response*).
/// 
/// * [locations custom classes delete projects](ProjectLocationCustomClasseDeleteCall) (response)
...
/// The list links the activity name, along with information about where it is used (one of *request* and *response*).
/// 
/// * [locations custom classes list projects](ProjectLocationCustomClasseListCall) (response)
/// 
#[derive(Default, Clone, Debug, Serialize, Deserialize)]
...
/// Create a custom class.
///
/// A builder for the *locations.customClasses.create* method supported by a *project* resource.
...
/// # extern crate hyper_rustls;
/// # extern crate google_speech1 as speech1;
/// use speech1::api::CreateCustomClassRequest;
/// # async fn dox() {
/// # use std::default::Default;
/// # use speech1::{Speech, oauth2, hyper, hyper_rustls};
/// 
...
/// // Values shown here are possibly random and not representative !
/// let mut req = CreateCustomClassRequest::default();
/// 
/// // You can configure optional parameters by calling the respective setters at will, and
/// // execute the final call using `doit()`.
/// // Values shown here are possibly random and not representative !
/// let result = hub.projects().locations_custom_classes_create(req, "parent")
///              .doit().await;
/// # }
/// ```
...
impl<'a> ProjectLocationCustomClasseCreateCall<'a> {
    ...
    /// Perform the operation you have build so far.
    pub async fn doit(mut self) -> client::Result<(hyper::Response<hyper::body::Body>, CustomClass)> {
        use url::percent_encoding::{percent_encode, DEFAULT_ENCODE_SET};
        use std::io::{Read, Seek};
        use hyper::header::{CONTENT_TYPE, CONTENT_LENGTH, AUTHORIZATION, USER_AGENT, LOCATION};
        use client::ToParts;
        ...
        dlg.begin(client::MethodInfo { id: "speech.projects.locations.customClasses.create",
        ...
        let mut url = self.hub._base_url.clone() + "v1/{+parent}/customClasses";
        if self._scopes.len() == 0 {
            self._scopes.insert(Scope::CloudPlatform.as_ref().to_string(), ());
        }
...
/// Delete a custom class.
///
/// A builder for the *locations.customClasses.delete* method supported by a *project* resource.
/// It is not used directly, but through a `ProjectMethods` instance.
///
/// # Example
///
...
/// // execute the final call using `doit()`.
/// // Values shown here are possibly random and not representative !
/// let result = hub.projects().locations_custom_classes_delete("name")
///              .doit().await;
/// # }
/// ```
...
impl<'a> ProjectLocationCustomClasseDeleteCall<'a> {
    ...
    pub async fn doit(mut self) -> client::Result<(hyper::Response<hyper::body::Body>, Empty)> {
        ...
        dlg.begin(client::MethodInfo { id: "speech.projects.locations.customClasses.delete",
...
/// Get a custom class.
///
/// A builder for the *locations.customClasses.get* method supported by a *project* resource.
/// It is not used directly, but through a `ProjectMethods` instance.
///
/// # Example
///
...
/// // execute the final call using `doit()`.
/// // Values shown here are possibly random and not representative !
/// let result = hub.projects().locations_custom_classes_get("name")
///              .doit().await;
/// # }
/// ```
...
impl<'a> ProjectLocationCustomClasseGetCall<'a> {
    ...
    pub async fn doit(mut self) -> client::Result<(hyper::Response<hyper::body::Body>, CustomClass)> {
        ...
        dlg.begin(client::MethodInfo { id: "speech.projects.locations.customClasses.get",
                               http_method: hyper::Method::GET });
        let mut params: Vec<(&str, String)> = Vec::with_capacity(3 + self._additional_params.len());
        params.push(("name", self._name.to_string()));
        for &field in ["alt", "name"].iter() {
...
/// List custom classes.
///
/// A builder for the *locations.customClasses.list* method supported by a *project* resource.
/// It is not used directly, but through a `ProjectMethods` instance.
///
/// # Example
///
...
impl<'a> ProjectLocationCustomClasseListCall<'a> {
    ...
    /// Perform the operation you have build so far.
    pub async fn doit(mut self) -> client::Result<(hyper::Response<hyper::body::Body>, ListCustomClassesResponse)> {
        use url::percent_encoding::{percent_encode, DEFAULT_ENCODE_SET};
        use std::io::{Read, Seek};
        use hyper::header::{CONTENT_TYPE, CONTENT_LENGTH, AUTHORIZATION, USER_AGENT, LOCATION};
        use client::ToParts;
        ...
        dlg.begin(client::MethodInfo { id: "speech.projects.locations.customClasses.list",
                               http_method: hyper::Method::GET });
...
/// Update a custom class.
///
/// A builder for the *locations.customClasses.patch* method supported by a *project* resource.
/// It is not used directly, but through a `ProjectMethods` instance.
///
/// # Example
///
...
impl<'a> ProjectLocationCustomClassePatchCall<'a> {
    ...
    pub async fn doit(mut self) -> client::Result<(hyper::Response<hyper::body::Body>, CustomClass)> {
        ...
        dlg.begin(client::MethodInfo { id: "speech.projects.locations.customClasses.patch",
...
/// Create a set of phrase hints. Each item in the set can be a single word or a multi-word phrase. The items in the PhraseSet are favored by the recognition model when you send a call that includes the PhraseSet.
///
/// A builder for the *locations.phraseSets.create* method supported by a *project* resource.
/// It is not used directly, but through a `ProjectMethods` instance.
///
/// # Example
///
...
/// # extern crate hyper_rustls;
/// # extern crate google_speech1 as speech1;
/// use speech1::api::CreatePhraseSetRequest;
/// # async fn dox() {
/// # use std::default::Default;
/// # use speech1::{Speech, oauth2, hyper, hyper_rustls};
/// 
...
/// // into the respective structure. Some of the parts shown here might not be applicable !
/// // Values shown here are possibly random and not representative !
/// let mut req = CreatePhraseSetRequest::default();
/// 
/// // You can configure optional parameters by calling the respective setters at will, and
/// // execute the final call using `doit()`.
/// // Values shown here are possibly random and not representative !
/// let result = hub.projects().locations_phrase_sets_create(req, "parent")
///              .doit().await;
/// # }
/// ```
...
impl<'a> ProjectLocationPhraseSetCreateCall<'a> {
    ...
    /// Perform the operation you have build so far.
    pub async fn doit(mut self) -> client::Result<(hyper::Response<hyper::body::Body>, PhraseSet)> {
        use url::percent_encoding::{percent_encode, DEFAULT_ENCODE_SET};
        use std::io::{Read, Seek};
        use hyper::header::{CONTENT_TYPE, CONTENT_LENGTH, AUTHORIZATION, USER_AGENT, LOCATION};
        use client::ToParts;
        ...
        dlg.begin(client::MethodInfo { id: "speech.projects.locations.phraseSets.create",
                               http_method: hyper::Method::POST });
        let mut params: Vec<(&str, String)> = Vec::with_capacity(4 + self._additional_params.len());
        params.push(("parent", self._parent.to_string()));
        for &field in ["alt", "parent"].iter() {
        ...
        let mut url = self.hub._base_url.clone() + "v1/{+parent}/phraseSets";
        if self._scopes.len() == 0 {
            self._scopes.insert(Scope::CloudPlatform.as_ref().to_string(), ());
        }
...
/// Delete a phrase set.
///
/// A builder for the *locations.phraseSets.delete* method supported by a *project* resource.
/// It is not used directly, but through a `ProjectMethods` instance.
///
/// # Example
///
...
/// // execute the final call using `doit()`.
/// // Values shown here are possibly random and not representative !
/// let result = hub.projects().locations_phrase_sets_delete("name")
///              .doit().await;
/// # }
/// ```
...
impl<'a> ProjectLocationPhraseSetDeleteCall<'a> {
    ...
    pub async fn doit(mut self) -> client::Result<(hyper::Response<hyper::body::Body>, Empty)> {
        ...
        dlg.begin(client::MethodInfo { id: "speech.projects.locations.phraseSets.delete",
                               http_method: hyper::Method::DELETE });
        let mut params: Vec<(&str, String)> = Vec::with_capacity(3 + self._additional_params.len());
        params.push(("name", self._name.to_string()));
        for &field in ["alt", "name"].iter() {
...
/// Get a phrase set.
///
/// A builder for the *locations.phraseSets.get* method supported by a *project* resource.
/// It is not used directly, but through a `ProjectMethods` instance.
///
/// # Example
///
...
/// // execute the final call using `doit()`.
/// // Values shown here are possibly random and not representative !
/// let result = hub.projects().locations_phrase_sets_get("name")
///              .doit().await;
/// # }
/// ```
...
impl<'a> ProjectLocationPhraseSetGetCall<'a> {
    ...
    pub async fn doit(mut self) -> client::Result<(hyper::Response<hyper::body::Body>, PhraseSet)> {
        ...
        dlg.begin(client::MethodInfo { id: "speech.projects.locations.phraseSets.get",
                               http_method: hyper::Method::GET });
        let mut params: Vec<(&str, String)> = Vec::with_capacity(3 + self._additional_params.len());
        params.push(("name", self._name.to_string()));
        for &field in ["alt", "name"].iter() {
...
/// List phrase sets.
///
/// A builder for the *locations.phraseSets.list* method supported by a *project* resource.
/// It is not used directly, but through a `ProjectMethods` instance.
///
/// # Example
///
...
impl<'a> ProjectLocationPhraseSetListCall<'a> {
    ...
    /// Perform the operation you have build so far.
    pub async fn doit(mut self) -> client::Result<(hyper::Response<hyper::body::Body>, ListPhraseSetResponse)> {
        use url::percent_encoding::{percent_encode, DEFAULT_ENCODE_SET};
        use std::io::{Read, Seek};
        use hyper::header::{CONTENT_TYPE, CONTENT_LENGTH, AUTHORIZATION, USER_AGENT, LOCATION};
        use client::ToParts;
        ...
        dlg.begin(client::MethodInfo { id: "speech.projects.locations.phraseSets.list",
                               http_method: hyper::Method::GET });
        let mut params: Vec<(&str, String)> = Vec::with_capacity(5 + self._additional_params.len());
        params.push(("parent", self._parent.to_string()));
        if let Some(value) = self._page_token {
...
/// Update a phrase set.
///
/// A builder for the *locations.phraseSets.patch* method supported by a *project* resource.
/// It is not used directly, but through a `ProjectMethods` instance.
///
/// # Example
///
...
/// // into the respective structure. Some of the parts shown here might not be applicable !
/// // Values shown here are possibly random and not representative !
/// let mut req = PhraseSet::default();
/// 
/// // You can configure optional parameters by calling the respective setters at will, and
/// // execute the final call using `doit()`.
/// // Values shown here are possibly random and not representative !
/// let result = hub.projects().locations_phrase_sets_patch(req, "name")
...
impl<'a> ProjectLocationPhraseSetPatchCall<'a> {
    ...
    pub async fn doit(mut self) -> client::Result<(hyper::Response<hyper::body::Body>, PhraseSet)> {
        ...
        dlg.begin(client::MethodInfo { id: "speech.projects.locations.phraseSets.patch",
                               http_method: hyper::Method::PATCH });
        let mut params: Vec<(&str, String)> = Vec::with_capacity(5 + self._additional_params.len());
        params.push(("name", self._name.to_string()));
        if let Some(value) = self._update_mask {
...
/// # extern crate hyper_rustls;
/// # extern crate google_speech1 as speech1;
/// use speech1::api::LongRunningRecognizeRequest;
/// # async fn dox() {
/// # use std::default::Default;
/// # use speech1::{Speech, oauth2, hyper, hyper_rustls};
/// 
...
impl<'a> SpeechLongrunningrecognizeCall<'a> {
    ...
    pub async fn doit(mut self) -> client::Result<(hyper::Response<hyper::body::Body>, Operation)> {
        ...
        dlg.begin(client::MethodInfo { id: "speech.speech.longrunningrecognize",
                               http_method: hyper::Method::POST });
        let mut params: Vec<(&str, String)> = Vec::with_capacity(3 + self._additional_params.len());
...
/// # extern crate hyper_rustls;
/// # extern crate google_speech1 as speech1;
/// use speech1::api::RecognizeRequest;
/// # async fn dox() {
/// # use std::default::Default;
/// # use speech1::{Speech, oauth2, hyper, hyper_rustls};
/// 
...
impl<'a> SpeechRecognizeCall<'a> {
    ...
    /// Perform the operation you have build so far.
    pub async fn doit(mut self) -> client::Result<(hyper::Response<hyper::body::Body>, RecognizeResponse)> {
        use std::io::{Read, Seek};
        use hyper::header::{CONTENT_TYPE, CONTENT_LENGTH, AUTHORIZATION, USER_AGENT, LOCATION};
        use client::ToParts;
        let mut dd = client::DefaultDelegate;
        ...
        dlg.begin(client::MethodInfo { id: "speech.speech.recognize",
                               http_method: hyper::Method::POST });
        let mut params: Vec<(&str, String)> = Vec::with_capacity(3 + self._additional_params.len());
        for &field in ["alt"].iter() {
            if self._additional_params.contains_key(field) {
