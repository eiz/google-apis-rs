...
/// * [locations find matches accounts](AccountLocationFindMatcheCall) (none)
...
/// The list links the activity name, along with information about where it is used (one of *request* and *response*).
/// 
/// * [locations find matches accounts](AccountLocationFindMatcheCall) (request)
/// 
#[derive(Default, Clone, Debug, Serialize, Deserialize)]
pub struct FindMatchingLocationsRequest {
    ...
    pub max_cache_duration: Option<String>,
...
/// The list links the activity name, along with information about where it is used (one of *request* and *response*).
/// 
/// * [locations find matches accounts](AccountLocationFindMatcheCall) (response)
/// 
#[derive(Default, Clone, Debug, Serialize, Deserialize)]
...
/// invitation.
///
/// A builder for the *admins.create* method supported by a *account* resource.
...
/// // Values shown here are possibly random and not representative !
/// let mut req = Admin::default();
/// 
/// // You can configure optional parameters by calling the respective setters at will, and
/// // execute the final call using `doit()`.
/// // Values shown here are possibly random and not representative !
/// let result = hub.accounts().admins_create(req, "parent")
///              .doit().await;
/// # }
/// ```
...
impl<'a> AccountAdminCreateCall<'a> {
    ...
    pub async fn doit(mut self) -> client::Result<(hyper::Response<hyper::body::Body>, Admin)> {
        ...
        dlg.begin(client::MethodInfo { id: "mybusiness.accounts.admins.create",
        ...
        let mut url = self.hub._base_url.clone() + "v4/{+parent}/admins";
...
/// Removes the specified admin from the specified account.
///
/// A builder for the *admins.delete* method supported by a *account* resource.
/// It is not used directly, but through a `AccountMethods` instance.
///
/// # Example
///
...
/// // execute the final call using `doit()`.
/// // Values shown here are possibly random and not representative !
/// let result = hub.accounts().admins_delete("name")
///              .doit().await;
/// # }
/// ```
...
impl<'a> AccountAdminDeleteCall<'a> {
    ...
    pub async fn doit(mut self) -> client::Result<(hyper::Response<hyper::body::Body>, Empty)> {
        ...
        dlg.begin(client::MethodInfo { id: "mybusiness.accounts.admins.delete",
...
/// Lists the admins for the specified account.
///
/// A builder for the *admins.list* method supported by a *account* resource.
/// It is not used directly, but through a `AccountMethods` instance.
///
/// # Example
///
...
/// // execute the final call using `doit()`.
/// // Values shown here are possibly random and not representative !
/// let result = hub.accounts().admins_list("parent")
///              .doit().await;
/// # }
/// ```
...
impl<'a> AccountAdminListCall<'a> {
    ...
    /// Perform the operation you have build so far.
    pub async fn doit(mut self) -> client::Result<(hyper::Response<hyper::body::Body>, ListAccountAdminsResponse)> {
        use url::percent_encoding::{percent_encode, DEFAULT_ENCODE_SET};
        use std::io::{Read, Seek};
        use hyper::header::{CONTENT_TYPE, CONTENT_LENGTH, AUTHORIZATION, USER_AGENT, LOCATION};
        use client::ToParts;
        ...
        dlg.begin(client::MethodInfo { id: "mybusiness.accounts.admins.list",
...
/// the Admin can be updated.
///
/// A builder for the *admins.patch* method supported by a *account* resource.
/// It is not used directly, but through a `AccountMethods` instance.
///
/// # Example
///
...
/// // execute the final call using `doit()`.
/// // Values shown here are possibly random and not representative !
/// let result = hub.accounts().admins_patch(req, "name")
///              .doit().await;
/// # }
/// ```
...
impl<'a> AccountAdminPatchCall<'a> {
    ...
    pub async fn doit(mut self) -> client::Result<(hyper::Response<hyper::body::Body>, Admin)> {
        ...
        dlg.begin(client::MethodInfo { id: "mybusiness.accounts.admins.patch",
...
/// Accepts the specified invitation.
///
/// A builder for the *invitations.accept* method supported by a *account* resource.
/// It is not used directly, but through a `AccountMethods` instance.
///
/// # Example
///
...
/// # extern crate hyper_rustls;
/// # extern crate google_mybusiness4 as mybusiness4;
/// use mybusiness4::api::AcceptInvitationRequest;
/// # async fn dox() {
/// # use std::default::Default;
/// # use mybusiness4::{MyBusiness, oauth2, hyper, hyper_rustls};
/// 
...
/// // into the respective structure. Some of the parts shown here might not be applicable !
/// // Values shown here are possibly random and not representative !
/// let mut req = AcceptInvitationRequest::default();
/// 
/// // You can configure optional parameters by calling the respective setters at will, and
/// // execute the final call using `doit()`.
/// // Values shown here are possibly random and not representative !
/// let result = hub.accounts().invitations_accept(req, "name")
///              .doit().await;
/// # }
/// ```
...
impl<'a> AccountInvitationAcceptCall<'a> {
    ...
    pub async fn doit(mut self) -> client::Result<(hyper::Response<hyper::body::Body>, Empty)> {
        ...
        dlg.begin(client::MethodInfo { id: "mybusiness.accounts.invitations.accept",
                               http_method: hyper::Method::POST });
        let mut params: Vec<(&str, String)> = Vec::with_capacity(4 + self._additional_params.len());
        params.push(("name", self._name.to_string()));
        for &field in ["alt", "name"].iter() {
        ...
        let mut url = self.hub._base_url.clone() + "v4/{+name}:accept";
...
/// Declines the specified invitation.
///
/// A builder for the *invitations.decline* method supported by a *account* resource.
/// It is not used directly, but through a `AccountMethods` instance.
///
/// # Example
///
...
/// # extern crate hyper_rustls;
/// # extern crate google_mybusiness4 as mybusiness4;
/// use mybusiness4::api::DeclineInvitationRequest;
/// # async fn dox() {
/// # use std::default::Default;
/// # use mybusiness4::{MyBusiness, oauth2, hyper, hyper_rustls};
/// 
...
/// // into the respective structure. Some of the parts shown here might not be applicable !
/// // Values shown here are possibly random and not representative !
/// let mut req = DeclineInvitationRequest::default();
/// 
/// // You can configure optional parameters by calling the respective setters at will, and
/// // execute the final call using `doit()`.
/// // Values shown here are possibly random and not representative !
/// let result = hub.accounts().invitations_decline(req, "name")
///              .doit().await;
/// # }
/// ```
...
impl<'a> AccountInvitationDeclineCall<'a> {
    ...
    pub async fn doit(mut self) -> client::Result<(hyper::Response<hyper::body::Body>, Empty)> {
        ...
        dlg.begin(client::MethodInfo { id: "mybusiness.accounts.invitations.decline",
                               http_method: hyper::Method::POST });
        let mut params: Vec<(&str, String)> = Vec::with_capacity(4 + self._additional_params.len());
        params.push(("name", self._name.to_string()));
        for &field in ["alt", "name"].iter() {
        ...
        let mut url = self.hub._base_url.clone() + "v4/{+name}:decline";
...
/// Lists pending invitations for the specified account.
///
/// A builder for the *invitations.list* method supported by a *account* resource.
/// It is not used directly, but through a `AccountMethods` instance.
///
/// # Example
///
...
/// // execute the final call using `doit()`.
/// // Values shown here are possibly random and not representative !
/// let result = hub.accounts().invitations_list("parent")
///              .target_type("ut")
///              .doit().await;
/// # }
/// ```
...
impl<'a> AccountInvitationListCall<'a> {
    ...
    /// Perform the operation you have build so far.
    pub async fn doit(mut self) -> client::Result<(hyper::Response<hyper::body::Body>, ListInvitationsResponse)> {
        use url::percent_encoding::{percent_encode, DEFAULT_ENCODE_SET};
        use std::io::{Read, Seek};
        use hyper::header::{CONTENT_TYPE, CONTENT_LENGTH, AUTHORIZATION, USER_AGENT, LOCATION};
        use client::ToParts;
        ...
        dlg.begin(client::MethodInfo { id: "mybusiness.accounts.invitations.list",
                               http_method: hyper::Method::GET });
        let mut params: Vec<(&str, String)> = Vec::with_capacity(4 + self._additional_params.len());
        params.push(("parent", self._parent.to_string()));
        ...
        let mut url = self.hub._base_url.clone() + "v4/{+parent}/invitations";
...
/// invitation.
///
/// A builder for the *locations.admins.create* method supported by a *account* resource.
/// It is not used directly, but through a `AccountMethods` instance.
///
/// # Example
///
...
/// // execute the final call using `doit()`.
/// // Values shown here are possibly random and not representative !
/// let result = hub.accounts().locations_admins_create(req, "parent")
///              .doit().await;
/// # }
/// ```
...
impl<'a> AccountLocationAdminCreateCall<'a> {
    ...
    pub async fn doit(mut self) -> client::Result<(hyper::Response<hyper::body::Body>, Admin)> {
        ...
        dlg.begin(client::MethodInfo { id: "mybusiness.accounts.locations.admins.create",
                               http_method: hyper::Method::POST });
        let mut params: Vec<(&str, String)> = Vec::with_capacity(4 + self._additional_params.len());
        params.push(("parent", self._parent.to_string()));
        for &field in ["alt", "parent"].iter() {
...
/// Removes the specified admin as a manager of the specified location.
///
/// A builder for the *locations.admins.delete* method supported by a *account* resource.
/// It is not used directly, but through a `AccountMethods` instance.
///
/// # Example
///
...
/// // execute the final call using `doit()`.
/// // Values shown here are possibly random and not representative !
/// let result = hub.accounts().locations_admins_delete("name")
///              .doit().await;
/// # }
/// ```
...
impl<'a> AccountLocationAdminDeleteCall<'a> {
    ...
    pub async fn doit(mut self) -> client::Result<(hyper::Response<hyper::body::Body>, Empty)> {
        ...
        dlg.begin(client::MethodInfo { id: "mybusiness.accounts.locations.admins.delete",
                               http_method: hyper::Method::DELETE });
        let mut params: Vec<(&str, String)> = Vec::with_capacity(3 + self._additional_params.len());
        params.push(("name", self._name.to_string()));
        for &field in ["alt", "name"].iter() {
...
/// Lists all of the admins for the specified location.
///
/// A builder for the *locations.admins.list* method supported by a *account* resource.
/// It is not used directly, but through a `AccountMethods` instance.
///
/// # Example
///
...
/// // execute the final call using `doit()`.
/// // Values shown here are possibly random and not representative !
/// let result = hub.accounts().locations_admins_list("parent")
///              .doit().await;
/// # }
/// ```
...
impl<'a> AccountLocationAdminListCall<'a> {
    ...
    /// Perform the operation you have build so far.
    pub async fn doit(mut self) -> client::Result<(hyper::Response<hyper::body::Body>, ListLocationAdminsResponse)> {
        use url::percent_encoding::{percent_encode, DEFAULT_ENCODE_SET};
        use std::io::{Read, Seek};
        use hyper::header::{CONTENT_TYPE, CONTENT_LENGTH, AUTHORIZATION, USER_AGENT, LOCATION};
        use client::ToParts;
        ...
        dlg.begin(client::MethodInfo { id: "mybusiness.accounts.locations.admins.list",
                               http_method: hyper::Method::GET });
        let mut params: Vec<(&str, String)> = Vec::with_capacity(3 + self._additional_params.len());
        params.push(("parent", self._parent.to_string()));
        for &field in ["alt", "parent"].iter() {
...
/// the Admin can be updated.
///
/// A builder for the *locations.admins.patch* method supported by a *account* resource.
/// It is not used directly, but through a `AccountMethods` instance.
///
/// # Example
///
...
/// // execute the final call using `doit()`.
/// // Values shown here are possibly random and not representative !
/// let result = hub.accounts().locations_admins_patch(req, "name")
///              .doit().await;
/// # }
/// ```
...
impl<'a> AccountLocationAdminPatchCall<'a> {
    ...
    pub async fn doit(mut self) -> client::Result<(hyper::Response<hyper::body::Body>, Admin)> {
        ...
        dlg.begin(client::MethodInfo { id: "mybusiness.accounts.locations.admins.patch",
                               http_method: hyper::Method::PATCH });
        let mut params: Vec<(&str, String)> = Vec::with_capacity(4 + self._additional_params.len());
        params.push(("name", self._name.to_string()));
        for &field in ["alt", "name"].iter() {
...
/// connected to Maps.
///
/// A builder for the *locations.followers.getMetadata* method supported by a *account* resource.
/// It is not used directly, but through a `AccountMethods` instance.
///
/// # Example
///
...
/// // execute the final call using `doit()`.
/// // Values shown here are possibly random and not representative !
/// let result = hub.accounts().locations_followers_get_metadata("name")
///              .doit().await;
/// # }
/// ```
...
impl<'a> AccountLocationFollowerGetMetadataCall<'a> {
    ...
    /// Perform the operation you have build so far.
    pub async fn doit(mut self) -> client::Result<(hyper::Response<hyper::body::Body>, FollowersMetadata)> {
        use url::percent_encoding::{percent_encode, DEFAULT_ENCODE_SET};
        use std::io::{Read, Seek};
        use hyper::header::{CONTENT_TYPE, CONTENT_LENGTH, AUTHORIZATION, USER_AGENT, LOCATION};
        use client::ToParts;
        ...
        dlg.begin(client::MethodInfo { id: "mybusiness.accounts.locations.followers.getMetadata",
                               http_method: hyper::Method::GET });
        let mut params: Vec<(&str, String)> = Vec::with_capacity(3 + self._additional_params.len());
        params.push(("name", self._name.to_string()));
        for &field in ["alt", "name"].iter() {
...
/// returns it.
///
/// A builder for the *locations.localPosts.create* method supported by a *account* resource.
/// It is not used directly, but through a `AccountMethods` instance.
///
/// # Example
///
...
/// // into the respective structure. Some of the parts shown here might not be applicable !
/// // Values shown here are possibly random and not representative !
/// let mut req = LocalPost::default();
/// 
/// // You can configure optional parameters by calling the respective setters at will, and
/// // execute the final call using `doit()`.
/// // Values shown here are possibly random and not representative !
/// let result = hub.accounts().locations_local_posts_create(req, "parent")
///              .doit().await;
/// # }
/// ```
...
impl<'a> AccountLocationLocalPostCreateCall<'a> {
    ...
    /// Perform the operation you have build so far.
    pub async fn doit(mut self) -> client::Result<(hyper::Response<hyper::body::Body>, LocalPost)> {
        use url::percent_encoding::{percent_encode, DEFAULT_ENCODE_SET};
        use std::io::{Read, Seek};
        use hyper::header::{CONTENT_TYPE, CONTENT_LENGTH, AUTHORIZATION, USER_AGENT, LOCATION};
        use client::ToParts;
        ...
        dlg.begin(client::MethodInfo { id: "mybusiness.accounts.locations.localPosts.create",
                               http_method: hyper::Method::POST });
        let mut params: Vec<(&str, String)> = Vec::with_capacity(4 + self._additional_params.len());
        params.push(("parent", self._parent.to_string()));
        for &field in ["alt", "parent"].iter() {
        ...
        let mut url = self.hub._base_url.clone() + "v4/{+parent}/localPosts";
...
/// Returns `NOT_FOUND` if the local post does not exist.
///
/// A builder for the *locations.localPosts.delete* method supported by a *account* resource.
/// It is not used directly, but through a `AccountMethods` instance.
///
/// # Example
///
...
/// // execute the final call using `doit()`.
/// // Values shown here are possibly random and not representative !
/// let result = hub.accounts().locations_local_posts_delete("name")
///              .doit().await;
/// # }
/// ```
...
impl<'a> AccountLocationLocalPostDeleteCall<'a> {
    ...
    pub async fn doit(mut self) -> client::Result<(hyper::Response<hyper::body::Body>, Empty)> {
        ...
        dlg.begin(client::MethodInfo { id: "mybusiness.accounts.locations.localPosts.delete",
                               http_method: hyper::Method::DELETE });
        let mut params: Vec<(&str, String)> = Vec::with_capacity(3 + self._additional_params.len());
        params.push(("name", self._name.to_string()));
        for &field in ["alt", "name"].iter() {
...
/// Returns `NOT_FOUND` if the local post does not exist.
///
/// A builder for the *locations.localPosts.get* method supported by a *account* resource.
/// It is not used directly, but through a `AccountMethods` instance.
///
/// # Example
///
...
/// // execute the final call using `doit()`.
/// // Values shown here are possibly random and not representative !
/// let result = hub.accounts().locations_local_posts_get("name")
///              .doit().await;
/// # }
/// ```
...
impl<'a> AccountLocationLocalPostGetCall<'a> {
    ...
    pub async fn doit(mut self) -> client::Result<(hyper::Response<hyper::body::Body>, LocalPost)> {
        ...
        dlg.begin(client::MethodInfo { id: "mybusiness.accounts.locations.localPosts.get",
                               http_method: hyper::Method::GET });
        let mut params: Vec<(&str, String)> = Vec::with_capacity(3 + self._additional_params.len());
        params.push(("name", self._name.to_string()));
        for &field in ["alt", "name"].iter() {
...
/// Returns a list of local posts associated with a location.
///
/// A builder for the *locations.localPosts.list* method supported by a *account* resource.
/// It is not used directly, but through a `AccountMethods` instance.
///
/// # Example
///
...
/// // execute the final call using `doit()`.
/// // Values shown here are possibly random and not representative !
/// let result = hub.accounts().locations_local_posts_list("parent")
///              .page_token("Lorem")
///              .page_size(-25)
///              .doit().await;
/// # }
...
impl<'a> AccountLocationLocalPostListCall<'a> {
    ...
    /// Perform the operation you have build so far.
    pub async fn doit(mut self) -> client::Result<(hyper::Response<hyper::body::Body>, ListLocalPostsResponse)> {
        use url::percent_encoding::{percent_encode, DEFAULT_ENCODE_SET};
        use std::io::{Read, Seek};
        use hyper::header::{CONTENT_TYPE, CONTENT_LENGTH, AUTHORIZATION, USER_AGENT, LOCATION};
        use client::ToParts;
        ...
        dlg.begin(client::MethodInfo { id: "mybusiness.accounts.locations.localPosts.list",
                               http_method: hyper::Method::GET });
...
/// Updates the specified local post and returns the updated local post.
///
/// A builder for the *locations.localPosts.patch* method supported by a *account* resource.
/// It is not used directly, but through a `AccountMethods` instance.
///
/// # Example
///
...
impl<'a> AccountLocationLocalPostPatchCall<'a> {
    ...
    pub async fn doit(mut self) -> client::Result<(hyper::Response<hyper::body::Body>, LocalPost)> {
        ...
        dlg.begin(client::MethodInfo { id: "mybusiness.accounts.locations.localPosts.patch",
                               http_method: hyper::Method::PATCH });
        let mut params: Vec<(&str, String)> = Vec::with_capacity(5 + self._additional_params.len());
        params.push(("name", self._name.to_string()));
...
/// to 100 `local_post_names` per call.</aside>
///
/// A builder for the *locations.localPosts.reportInsights* method supported by a *account* resource.
/// It is not used directly, but through a `AccountMethods` instance.
///
/// # Example
///
...
/// # extern crate hyper_rustls;
/// # extern crate google_mybusiness4 as mybusiness4;
/// use mybusiness4::api::ReportLocalPostInsightsRequest;
/// # async fn dox() {
/// # use std::default::Default;
/// # use mybusiness4::{MyBusiness, oauth2, hyper, hyper_rustls};
/// 
...
/// // into the respective structure. Some of the parts shown here might not be applicable !
/// // Values shown here are possibly random and not representative !
/// let mut req = ReportLocalPostInsightsRequest::default();
/// 
/// // You can configure optional parameters by calling the respective setters at will, and
/// // execute the final call using `doit()`.
/// // Values shown here are possibly random and not representative !
/// let result = hub.accounts().locations_local_posts_report_insights(req, "name")
///              .doit().await;
/// # }
/// ```
...
impl<'a> AccountLocationLocalPostReportInsightCall<'a> {
    ...
    /// Perform the operation you have build so far.
    pub async fn doit(mut self) -> client::Result<(hyper::Response<hyper::body::Body>, ReportLocalPostInsightsResponse)> {
        use url::percent_encoding::{percent_encode, DEFAULT_ENCODE_SET};
        use std::io::{Read, Seek};
        use hyper::header::{CONTENT_TYPE, CONTENT_LENGTH, AUTHORIZATION, USER_AGENT, LOCATION};
        use client::ToParts;
        ...
        dlg.begin(client::MethodInfo { id: "mybusiness.accounts.locations.localPosts.reportInsights",
                               http_method: hyper::Method::POST });
        let mut params: Vec<(&str, String)> = Vec::with_capacity(4 + self._additional_params.len());
        params.push(("name", self._name.to_string()));
        for &field in ["alt", "name"].iter() {
        ...
        let mut url = self.hub._base_url.clone() + "v4/{+name}/localPosts:reportInsights";
...
/// Returns metadata for the requested customer media item.
///
/// A builder for the *locations.media.customers.get* method supported by a *account* resource.
/// It is not used directly, but through a `AccountMethods` instance.
///
/// # Example
///
...
/// // execute the final call using `doit()`.
/// // Values shown here are possibly random and not representative !
/// let result = hub.accounts().locations_media_customers_get("name")
///              .doit().await;
/// # }
/// ```
...
impl<'a> AccountLocationMediaCustomerGetCall<'a> {
    ...
    pub async fn doit(mut self) -> client::Result<(hyper::Response<hyper::body::Body>, MediaItem)> {
        ...
        dlg.begin(client::MethodInfo { id: "mybusiness.accounts.locations.media.customers.get",
                               http_method: hyper::Method::GET });
        let mut params: Vec<(&str, String)> = Vec::with_capacity(3 + self._additional_params.len());
        params.push(("name", self._name.to_string()));
        for &field in ["alt", "name"].iter() {
...
/// contributed by customers.
///
/// A builder for the *locations.media.customers.list* method supported by a *account* resource.
/// It is not used directly, but through a `AccountMethods` instance.
///
/// # Example
///
...
/// // execute the final call using `doit()`.
/// // Values shown here are possibly random and not representative !
/// let result = hub.accounts().locations_media_customers_list("parent")
///              .page_token("Stet")
///              .page_size(-13)
///              .doit().await;
/// # }
...
impl<'a> AccountLocationMediaCustomerListCall<'a> {
    ...
    /// Perform the operation you have build so far.
    pub async fn doit(mut self) -> client::Result<(hyper::Response<hyper::body::Body>, ListCustomerMediaItemsResponse)> {
        use url::percent_encoding::{percent_encode, DEFAULT_ENCODE_SET};
        use std::io::{Read, Seek};
        use hyper::header::{CONTENT_TYPE, CONTENT_LENGTH, AUTHORIZATION, USER_AGENT, LOCATION};
        use client::ToParts;
        ...
        dlg.begin(client::MethodInfo { id: "mybusiness.accounts.locations.media.customers.list",
                               http_method: hyper::Method::GET });
        let mut params: Vec<(&str, String)> = Vec::with_capacity(5 + self._additional_params.len());
        params.push(("parent", self._parent.to_string()));
        if let Some(value) = self._page_token {
        ...
        let mut url = self.hub._base_url.clone() + "v4/{+parent}/media/customers";
...
/// Creates a new media item for the location.
///
/// A builder for the *locations.media.create* method supported by a *account* resource.
/// It is not used directly, but through a `AccountMethods` instance.
///
/// # Example
///
...
/// // execute the final call using `doit()`.
/// // Values shown here are possibly random and not representative !
/// let result = hub.accounts().locations_media_create(req, "parent")
///              .doit().await;
/// # }
/// ```
...
impl<'a> AccountLocationMediaCreateCall<'a> {
    ...
    pub async fn doit(mut self) -> client::Result<(hyper::Response<hyper::body::Body>, MediaItem)> {
        ...
        dlg.begin(client::MethodInfo { id: "mybusiness.accounts.locations.media.create",
                               http_method: hyper::Method::POST });
        let mut params: Vec<(&str, String)> = Vec::with_capacity(4 + self._additional_params.len());
        params.push(("parent", self._parent.to_string()));
        for &field in ["alt", "parent"].iter() {
        ...
        let mut url = self.hub._base_url.clone() + "v4/{+parent}/media";
...
/// Deletes the specified media item.
///
/// A builder for the *locations.media.delete* method supported by a *account* resource.
/// It is not used directly, but through a `AccountMethods` instance.
///
/// # Example
///
...
/// // execute the final call using `doit()`.
/// // Values shown here are possibly random and not representative !
/// let result = hub.accounts().locations_media_delete("name")
///              .doit().await;
/// # }
/// ```
...
impl<'a> AccountLocationMediaDeleteCall<'a> {
    ...
    pub async fn doit(mut self) -> client::Result<(hyper::Response<hyper::body::Body>, Empty)> {
        ...
        dlg.begin(client::MethodInfo { id: "mybusiness.accounts.locations.media.delete",
                               http_method: hyper::Method::DELETE });
        let mut params: Vec<(&str, String)> = Vec::with_capacity(3 + self._additional_params.len());
        params.push(("name", self._name.to_string()));
        for &field in ["alt", "name"].iter() {
...
/// Returns metadata for the requested media item.
///
/// A builder for the *locations.media.get* method supported by a *account* resource.
/// It is not used directly, but through a `AccountMethods` instance.
///
/// # Example
///
...
/// // execute the final call using `doit()`.
/// // Values shown here are possibly random and not representative !
/// let result = hub.accounts().locations_media_get("name")
///              .doit().await;
/// # }
/// ```
...
impl<'a> AccountLocationMediaGetCall<'a> {
    ...
    pub async fn doit(mut self) -> client::Result<(hyper::Response<hyper::body::Body>, MediaItem)> {
        ...
        dlg.begin(client::MethodInfo { id: "mybusiness.accounts.locations.media.get",
                               http_method: hyper::Method::GET });
        let mut params: Vec<(&str, String)> = Vec::with_capacity(3 + self._additional_params.len());
        params.push(("name", self._name.to_string()));
        for &field in ["alt", "name"].iter() {
...
/// Returns a list of media items associated with a location.
///
/// A builder for the *locations.media.list* method supported by a *account* resource.
/// It is not used directly, but through a `AccountMethods` instance.
///
/// # Example
///
...
/// // execute the final call using `doit()`.
/// // Values shown here are possibly random and not representative !
/// let result = hub.accounts().locations_media_list("parent")
///              .page_token("vero")
///              .page_size(-31)
///              .doit().await;
/// # }
...
impl<'a> AccountLocationMediaListCall<'a> {
    ...
    pub async fn doit(mut self) -> client::Result<(hyper::Response<hyper::body::Body>, ListMediaItemsResponse)> {
        ...
        dlg.begin(client::MethodInfo { id: "mybusiness.accounts.locations.media.list",
                               http_method: hyper::Method::GET });
        let mut params: Vec<(&str, String)> = Vec::with_capacity(5 + self._additional_params.len());
        params.push(("parent", self._parent.to_string()));
        if let Some(value) = self._page_token {
...
/// with the exception that the new category cannot be COVER or PROFILE.
///
/// A builder for the *locations.media.patch* method supported by a *account* resource.
/// It is not used directly, but through a `AccountMethods` instance.
///
/// # Example
///
...
/// // execute the final call using `doit()`.
/// // Values shown here are possibly random and not representative !
/// let result = hub.accounts().locations_media_patch(req, "name")
///              .update_mask("duo")
///              .doit().await;
/// # }
/// ```
...
impl<'a> AccountLocationMediaPatchCall<'a> {
    ...
    pub async fn doit(mut self) -> client::Result<(hyper::Response<hyper::body::Body>, MediaItem)> {
        ...
        dlg.begin(client::MethodInfo { id: "mybusiness.accounts.locations.media.patch",
                               http_method: hyper::Method::PATCH });
        let mut params: Vec<(&str, String)> = Vec::with_capacity(5 + self._additional_params.len());
        params.push(("name", self._name.to_string()));
        if let Some(value) = self._update_mask {
...
/// Generates a `MediaItemDataRef` for media item uploading.
///
/// A builder for the *locations.media.startUpload* method supported by a *account* resource.
/// It is not used directly, but through a `AccountMethods` instance.
///
/// # Example
///
...
/// # extern crate hyper_rustls;
/// # extern crate google_mybusiness4 as mybusiness4;
/// use mybusiness4::api::StartUploadMediaItemDataRequest;
/// # async fn dox() {
/// # use std::default::Default;
/// # use mybusiness4::{MyBusiness, oauth2, hyper, hyper_rustls};
/// 
...
/// // into the respective structure. Some of the parts shown here might not be applicable !
/// // Values shown here are possibly random and not representative !
/// let mut req = StartUploadMediaItemDataRequest::default();
/// 
/// // You can configure optional parameters by calling the respective setters at will, and
/// // execute the final call using `doit()`.
/// // Values shown here are possibly random and not representative !
/// let result = hub.accounts().locations_media_start_upload(req, "parent")
///              .doit().await;
/// # }
/// ```
...
impl<'a> AccountLocationMediaStartUploadCall<'a> {
    ...
    /// Perform the operation you have build so far.
    pub async fn doit(mut self) -> client::Result<(hyper::Response<hyper::body::Body>, MediaItemDataRef)> {
        use url::percent_encoding::{percent_encode, DEFAULT_ENCODE_SET};
        use std::io::{Read, Seek};
        use hyper::header::{CONTENT_TYPE, CONTENT_LENGTH, AUTHORIZATION, USER_AGENT, LOCATION};
        use client::ToParts;
        ...
        dlg.begin(client::MethodInfo { id: "mybusiness.accounts.locations.media.startUpload",
                               http_method: hyper::Method::POST });
        let mut params: Vec<(&str, String)> = Vec::with_capacity(4 + self._additional_params.len());
        params.push(("parent", self._parent.to_string()));
        for &field in ["alt", "parent"].iter() {
        ...
        let mut url = self.hub._base_url.clone() + "v4/{+parent}/media:startUpload";
...
/// Deletes the answer written by the current user to a question.
///
/// A builder for the *locations.questions.answers.delete* method supported by a *account* resource.
/// It is not used directly, but through a `AccountMethods` instance.
///
/// # Example
///
...
/// // execute the final call using `doit()`.
/// // Values shown here are possibly random and not representative !
/// let result = hub.accounts().locations_questions_answers_delete("parent")
///              .doit().await;
/// # }
/// ```
...
impl<'a> AccountLocationQuestionAnswerDeleteCall<'a> {
    ...
    pub async fn doit(mut self) -> client::Result<(hyper::Response<hyper::body::Body>, Empty)> {
        ...
        dlg.begin(client::MethodInfo { id: "mybusiness.accounts.locations.questions.answers.delete",
                               http_method: hyper::Method::DELETE });
        let mut params: Vec<(&str, String)> = Vec::with_capacity(3 + self._additional_params.len());
        params.push(("parent", self._parent.to_string()));
        for &field in ["alt", "parent"].iter() {
        ...
        let mut url = self.hub._base_url.clone() + "v4/{+parent}/answers:delete";
...
/// Returns the paginated list of answers for a specified question.
///
/// A builder for the *locations.questions.answers.list* method supported by a *account* resource.
/// It is not used directly, but through a `AccountMethods` instance.
///
/// # Example
///
...
/// // execute the final call using `doit()`.
/// // Values shown here are possibly random and not representative !
/// let result = hub.accounts().locations_questions_answers_list("parent")
///              .page_token("amet.")
///              .page_size(-96)
///              .order_by("diam")
///              .doit().await;
...
impl<'a> AccountLocationQuestionAnswerListCall<'a> {
    ...
    /// Perform the operation you have build so far.
    pub async fn doit(mut self) -> client::Result<(hyper::Response<hyper::body::Body>, ListAnswersResponse)> {
        use url::percent_encoding::{percent_encode, DEFAULT_ENCODE_SET};
        use std::io::{Read, Seek};
        use hyper::header::{CONTENT_TYPE, CONTENT_LENGTH, AUTHORIZATION, USER_AGENT, LOCATION};
        use client::ToParts;
        ...
        dlg.begin(client::MethodInfo { id: "mybusiness.accounts.locations.questions.answers.list",
                               http_method: hyper::Method::GET });
        ...
        let mut url = self.hub._base_url.clone() + "v4/{+parent}/answers";
...
/// the specified question. A user can only create one answer per question.
///
/// A builder for the *locations.questions.answers.upsert* method supported by a *account* resource.
/// It is not used directly, but through a `AccountMethods` instance.
///
/// # Example
///
...
/// # extern crate hyper_rustls;
/// # extern crate google_mybusiness4 as mybusiness4;
/// use mybusiness4::api::UpsertAnswerRequest;
/// # async fn dox() {
/// # use std::default::Default;
/// # use mybusiness4::{MyBusiness, oauth2, hyper, hyper_rustls};
/// 
...
/// // into the respective structure. Some of the parts shown here might not be applicable !
/// // Values shown here are possibly random and not representative !
/// let mut req = UpsertAnswerRequest::default();
/// 
/// // You can configure optional parameters by calling the respective setters at will, and
/// // execute the final call using `doit()`.
/// // Values shown here are possibly random and not representative !
/// let result = hub.accounts().locations_questions_answers_upsert(req, "parent")
///              .doit().await;
/// # }
/// ```
...
impl<'a> AccountLocationQuestionAnswerUpsertCall<'a> {
    ...
    /// Perform the operation you have build so far.
    pub async fn doit(mut self) -> client::Result<(hyper::Response<hyper::body::Body>, Answer)> {
        use url::percent_encoding::{percent_encode, DEFAULT_ENCODE_SET};
        use std::io::{Read, Seek};
        use hyper::header::{CONTENT_TYPE, CONTENT_LENGTH, AUTHORIZATION, USER_AGENT, LOCATION};
        use client::ToParts;
        ...
        dlg.begin(client::MethodInfo { id: "mybusiness.accounts.locations.questions.answers.upsert",
                               http_method: hyper::Method::POST });
        let mut params: Vec<(&str, String)> = Vec::with_capacity(4 + self._additional_params.len());
        params.push(("parent", self._parent.to_string()));
        for &field in ["alt", "parent"].iter() {
        ...
        let mut url = self.hub._base_url.clone() + "v4/{+parent}/answers:upsert";
...
/// Adds a question for the specified location.
///
/// A builder for the *locations.questions.create* method supported by a *account* resource.
/// It is not used directly, but through a `AccountMethods` instance.
///
/// # Example
///
...
/// // execute the final call using `doit()`.
/// // Values shown here are possibly random and not representative !
/// let result = hub.accounts().locations_questions_create(req, "parent")
///              .doit().await;
/// # }
/// ```
...
impl<'a> AccountLocationQuestionCreateCall<'a> {
    ...
    /// Perform the operation you have build so far.
    pub async fn doit(mut self) -> client::Result<(hyper::Response<hyper::body::Body>, Question)> {
        use url::percent_encoding::{percent_encode, DEFAULT_ENCODE_SET};
        use std::io::{Read, Seek};
        use hyper::header::{CONTENT_TYPE, CONTENT_LENGTH, AUTHORIZATION, USER_AGENT, LOCATION};
        use client::ToParts;
        ...
        dlg.begin(client::MethodInfo { id: "mybusiness.accounts.locations.questions.create",
                               http_method: hyper::Method::POST });
        let mut params: Vec<(&str, String)> = Vec::with_capacity(4 + self._additional_params.len());
        params.push(("parent", self._parent.to_string()));
        for &field in ["alt", "parent"].iter() {
        ...
        let mut url = self.hub._base_url.clone() + "v4/{+parent}/questions";
...
/// Deletes a specific question written by the current user.
///
/// A builder for the *locations.questions.delete* method supported by a *account* resource.
/// It is not used directly, but through a `AccountMethods` instance.
///
/// # Example
///
...
/// // execute the final call using `doit()`.
/// // Values shown here are possibly random and not representative !
/// let result = hub.accounts().locations_questions_delete("name")
///              .doit().await;
/// # }
/// ```
...
impl<'a> AccountLocationQuestionDeleteCall<'a> {
    ...
    pub async fn doit(mut self) -> client::Result<(hyper::Response<hyper::body::Body>, Empty)> {
        ...
        dlg.begin(client::MethodInfo { id: "mybusiness.accounts.locations.questions.delete",
                               http_method: hyper::Method::DELETE });
        let mut params: Vec<(&str, String)> = Vec::with_capacity(3 + self._additional_params.len());
        params.push(("name", self._name.to_string()));
        for &field in ["alt", "name"].iter() {
...
/// specified location.
///
/// A builder for the *locations.questions.list* method supported by a *account* resource.
/// It is not used directly, but through a `AccountMethods` instance.
///
/// # Example
///
...
pub struct AccountLocationQuestionListCall<'a>
    ...
    _answers_per_question: Option<i32>,
    _delegate: Option<&'a mut dyn client::Delegate>,
    _additional_params: HashMap<String, String>,
}
...
impl<'a> AccountLocationQuestionListCall<'a> {
    ...
    /// Perform the operation you have build so far.
    pub async fn doit(mut self) -> client::Result<(hyper::Response<hyper::body::Body>, ListQuestionsResponse)> {
        use url::percent_encoding::{percent_encode, DEFAULT_ENCODE_SET};
        use std::io::{Read, Seek};
        use hyper::header::{CONTENT_TYPE, CONTENT_LENGTH, AUTHORIZATION, USER_AGENT, LOCATION};
        use client::ToParts;
        ...
        dlg.begin(client::MethodInfo { id: "mybusiness.accounts.locations.questions.list",
                               http_method: hyper::Method::GET });
        ...
        if let Some(value) = self._answers_per_question {
            params.push(("answersPerQuestion", value.to_string()));
        }
        for &field in ["alt", "parent", "pageToken", "pageSize", "orderBy", "filter", "answersPerQuestion"].iter() {
            if self._additional_params.contains_key(field) {
                dlg.finished(false);
                return Err(client::Error::FieldClash(field));
            }
...
/// Updates a specific question written by the current user.
///
/// A builder for the *locations.questions.patch* method supported by a *account* resource.
/// It is not used directly, but through a `AccountMethods` instance.
///
/// # Example
///
...
/// // execute the final call using `doit()`.
/// // Values shown here are possibly random and not representative !
/// let result = hub.accounts().locations_questions_patch(req, "name")
///              .doit().await;
/// # }
/// ```
...
impl<'a> AccountLocationQuestionPatchCall<'a> {
    ...
    pub async fn doit(mut self) -> client::Result<(hyper::Response<hyper::body::Body>, Question)> {
        ...
        dlg.begin(client::MethodInfo { id: "mybusiness.accounts.locations.questions.patch",
                               http_method: hyper::Method::PATCH });
        let mut params: Vec<(&str, String)> = Vec::with_capacity(4 + self._additional_params.len());
        params.push(("name", self._name.to_string()));
        for &field in ["alt", "name"].iter() {
...
/// This operation is only valid if the specified location is verified.
///
/// A builder for the *locations.reviews.deleteReply* method supported by a *account* resource.
/// It is not used directly, but through a `AccountMethods` instance.
///
/// # Example
///
...
/// // execute the final call using `doit()`.
/// // Values shown here are possibly random and not representative !
/// let result = hub.accounts().locations_reviews_delete_reply("name")
///              .doit().await;
/// # }
/// ```
...
impl<'a> AccountLocationReviewDeleteReplyCall<'a> {
    ...
    pub async fn doit(mut self) -> client::Result<(hyper::Response<hyper::body::Body>, Empty)> {
        ...
        dlg.begin(client::MethodInfo { id: "mybusiness.accounts.locations.reviews.deleteReply",
                               http_method: hyper::Method::DELETE });
        let mut params: Vec<(&str, String)> = Vec::with_capacity(3 + self._additional_params.len());
        params.push(("name", self._name.to_string()));
        for &field in ["alt", "name"].iter() {
        ...
        let mut url = self.hub._base_url.clone() + "v4/{+name}/reply";
...
/// Returns `NOT_FOUND` if the review does not exist, or has been deleted.
///
/// A builder for the *locations.reviews.get* method supported by a *account* resource.
/// It is not used directly, but through a `AccountMethods` instance.
///
/// # Example
///
...
/// // execute the final call using `doit()`.
/// // Values shown here are possibly random and not representative !
/// let result = hub.accounts().locations_reviews_get("name")
///              .doit().await;
/// # }
/// ```
...
impl<'a> AccountLocationReviewGetCall<'a> {
    ...
    pub async fn doit(mut self) -> client::Result<(hyper::Response<hyper::body::Body>, Review)> {
        ...
        dlg.begin(client::MethodInfo { id: "mybusiness.accounts.locations.reviews.get",
                               http_method: hyper::Method::GET });
        let mut params: Vec<(&str, String)> = Vec::with_capacity(3 + self._additional_params.len());
        params.push(("name", self._name.to_string()));
        for &field in ["alt", "name"].iter() {
...
/// This operation is only valid if the specified location is verified.
///
/// A builder for the *locations.reviews.list* method supported by a *account* resource.
/// It is not used directly, but through a `AccountMethods` instance.
///
/// # Example
///
...
/// // execute the final call using `doit()`.
/// // Values shown here are possibly random and not representative !
/// let result = hub.accounts().locations_reviews_list("parent")
///              .page_token("Lorem")
///              .page_size(-29)
///              .order_by("no")
///              .doit().await;
...
impl<'a> AccountLocationReviewListCall<'a> {
    ...
    /// Perform the operation you have build so far.
    pub async fn doit(mut self) -> client::Result<(hyper::Response<hyper::body::Body>, ListReviewsResponse)> {
        use url::percent_encoding::{percent_encode, DEFAULT_ENCODE_SET};
        use std::io::{Read, Seek};
        use hyper::header::{CONTENT_TYPE, CONTENT_LENGTH, AUTHORIZATION, USER_AGENT, LOCATION};
        use client::ToParts;
        ...
        dlg.begin(client::MethodInfo { id: "mybusiness.accounts.locations.reviews.list",
                               http_method: hyper::Method::GET });
        let mut params: Vec<(&str, String)> = Vec::with_capacity(6 + self._additional_params.len());
        params.push(("parent", self._parent.to_string()));
        if let Some(value) = self._page_token {
        ...
        let mut url = self.hub._base_url.clone() + "v4/{+parent}/reviews";
...
/// This operation is only valid if the specified location is verified.
///
/// A builder for the *locations.reviews.updateReply* method supported by a *account* resource.
/// It is not used directly, but through a `AccountMethods` instance.
///
/// # Example
///
...
/// # extern crate hyper_rustls;
/// # extern crate google_mybusiness4 as mybusiness4;
/// use mybusiness4::api::ReviewReply;
/// # async fn dox() {
/// # use std::default::Default;
/// # use mybusiness4::{MyBusiness, oauth2, hyper, hyper_rustls};
/// 
...
/// // into the respective structure. Some of the parts shown here might not be applicable !
/// // Values shown here are possibly random and not representative !
/// let mut req = ReviewReply::default();
/// 
/// // You can configure optional parameters by calling the respective setters at will, and
/// // execute the final call using `doit()`.
/// // Values shown here are possibly random and not representative !
/// let result = hub.accounts().locations_reviews_update_reply(req, "name")
///              .doit().await;
/// # }
/// ```
...
impl<'a> AccountLocationReviewUpdateReplyCall<'a> {
    ...
    /// Perform the operation you have build so far.
    pub async fn doit(mut self) -> client::Result<(hyper::Response<hyper::body::Body>, ReviewReply)> {
        use url::percent_encoding::{percent_encode, DEFAULT_ENCODE_SET};
        use std::io::{Read, Seek};
        use hyper::header::{CONTENT_TYPE, CONTENT_LENGTH, AUTHORIZATION, USER_AGENT, LOCATION};
        use client::ToParts;
        ...
        dlg.begin(client::MethodInfo { id: "mybusiness.accounts.locations.reviews.updateReply",
...
/// verification request is instantly `VERIFIED` upon creation.
///
/// A builder for the *locations.verifications.complete* method supported by a *account* resource.
/// It is not used directly, but through a `AccountMethods` instance.
///
/// # Example
///
...
/// # extern crate hyper_rustls;
/// # extern crate google_mybusiness4 as mybusiness4;
/// use mybusiness4::api::CompleteVerificationRequest;
/// # async fn dox() {
/// # use std::default::Default;
/// # use mybusiness4::{MyBusiness, oauth2, hyper, hyper_rustls};
/// 
...
/// // into the respective structure. Some of the parts shown here might not be applicable !
/// // Values shown here are possibly random and not representative !
/// let mut req = CompleteVerificationRequest::default();
/// 
/// // You can configure optional parameters by calling the respective setters at will, and
/// // execute the final call using `doit()`.
/// // Values shown here are possibly random and not representative !
/// let result = hub.accounts().locations_verifications_complete(req, "name")
///              .doit().await;
/// # }
/// ```
...
impl<'a> AccountLocationVerificationCompleteCall<'a> {
    ...
    /// Perform the operation you have build so far.
    pub async fn doit(mut self) -> client::Result<(hyper::Response<hyper::body::Body>, CompleteVerificationResponse)> {
        use url::percent_encoding::{percent_encode, DEFAULT_ENCODE_SET};
        use std::io::{Read, Seek};
        use hyper::header::{CONTENT_TYPE, CONTENT_LENGTH, AUTHORIZATION, USER_AGENT, LOCATION};
        use client::ToParts;
        ...
        dlg.begin(client::MethodInfo { id: "mybusiness.accounts.locations.verifications.complete",
                               http_method: hyper::Method::POST });
        let mut params: Vec<(&str, String)> = Vec::with_capacity(4 + self._additional_params.len());
        params.push(("name", self._name.to_string()));
        for &field in ["alt", "name"].iter() {
        ...
        let mut url = self.hub._base_url.clone() + "v4/{+name}:complete";
...
/// List verifications of a location, ordered by create time.
///
/// A builder for the *locations.verifications.list* method supported by a *account* resource.
/// It is not used directly, but through a `AccountMethods` instance.
///
/// # Example
///
...
impl<'a> AccountLocationVerificationListCall<'a> {
    ...
    /// Perform the operation you have build so far.
    pub async fn doit(mut self) -> client::Result<(hyper::Response<hyper::body::Body>, ListVerificationsResponse)> {
        use url::percent_encoding::{percent_encode, DEFAULT_ENCODE_SET};
        use std::io::{Read, Seek};
        use hyper::header::{CONTENT_TYPE, CONTENT_LENGTH, AUTHORIZATION, USER_AGENT, LOCATION};
        use client::ToParts;
        ...
        dlg.begin(client::MethodInfo { id: "mybusiness.accounts.locations.verifications.list",
                               http_method: hyper::Method::GET });
        let mut params: Vec<(&str, String)> = Vec::with_capacity(5 + self._additional_params.len());
        params.push(("parent", self._parent.to_string()));
        if let Some(value) = self._page_token {
        ...
        let mut url = self.hub._base_url.clone() + "v4/{+parent}/verifications";
...
/// # extern crate hyper_rustls;
/// # extern crate google_mybusiness4 as mybusiness4;
/// use mybusiness4::api::AssociateLocationRequest;
/// # async fn dox() {
/// # use std::default::Default;
/// # use mybusiness4::{MyBusiness, oauth2, hyper, hyper_rustls};
/// 
...
impl<'a> AccountLocationAssociateCall<'a> {
    ...
    pub async fn doit(mut self) -> client::Result<(hyper::Response<hyper::body::Body>, Empty)> {
        ...
        dlg.begin(client::MethodInfo { id: "mybusiness.accounts.locations.associate",
                               http_method: hyper::Method::POST });
        let mut params: Vec<(&str, String)> = Vec::with_capacity(4 + self._additional_params.len());
        params.push(("name", self._name.to_string()));
        for &field in ["alt", "name"].iter() {
...
/// Gets all of the specified locations in the given account.
///
/// A builder for the *locations.batchGet* method supported by a *account* resource.
/// It is not used directly, but through a `AccountMethods` instance.
///
/// # Example
///
...
/// # extern crate hyper_rustls;
/// # extern crate google_mybusiness4 as mybusiness4;
/// use mybusiness4::api::BatchGetLocationsRequest;
/// # async fn dox() {
/// # use std::default::Default;
/// # use mybusiness4::{MyBusiness, oauth2, hyper, hyper_rustls};
/// 
...
/// // into the respective structure. Some of the parts shown here might not be applicable !
/// // Values shown here are possibly random and not representative !
/// let mut req = BatchGetLocationsRequest::default();
/// 
/// // You can configure optional parameters by calling the respective setters at will, and
/// // execute the final call using `doit()`.
/// // Values shown here are possibly random and not representative !
/// let result = hub.accounts().locations_batch_get(req, "name")
///              .doit().await;
/// # }
/// ```
...
impl<'a> AccountLocationBatchGetCall<'a> {
    ...
    /// Perform the operation you have build so far.
    pub async fn doit(mut self) -> client::Result<(hyper::Response<hyper::body::Body>, BatchGetLocationsResponse)> {
        use url::percent_encoding::{percent_encode, DEFAULT_ENCODE_SET};
        use std::io::{Read, Seek};
        use hyper::header::{CONTENT_TYPE, CONTENT_LENGTH, AUTHORIZATION, USER_AGENT, LOCATION};
        use client::ToParts;
        ...
        dlg.begin(client::MethodInfo { id: "mybusiness.accounts.locations.batchGet",
                               http_method: hyper::Method::POST });
        let mut params: Vec<(&str, String)> = Vec::with_capacity(4 + self._additional_params.len());
        params.push(("name", self._name.to_string()));
        for &field in ["alt", "name"].iter() {
        ...
        let mut url = self.hub._base_url.clone() + "v4/{+name}/locations:batchGet";
...
/// to a batch size of 200 `location_names` per call.</aside>
///
/// A builder for the *locations.batchGetReviews* method supported by a *account* resource.
/// It is not used directly, but through a `AccountMethods` instance.
///
/// # Example
///
...
/// # extern crate hyper_rustls;
/// # extern crate google_mybusiness4 as mybusiness4;
/// use mybusiness4::api::BatchGetReviewsRequest;
/// # async fn dox() {
/// # use std::default::Default;
/// # use mybusiness4::{MyBusiness, oauth2, hyper, hyper_rustls};
/// 
...
/// // into the respective structure. Some of the parts shown here might not be applicable !
/// // Values shown here are possibly random and not representative !
/// let mut req = BatchGetReviewsRequest::default();
/// 
/// // You can configure optional parameters by calling the respective setters at will, and
/// // execute the final call using `doit()`.
/// // Values shown here are possibly random and not representative !
/// let result = hub.accounts().locations_batch_get_reviews(req, "name")
///              .doit().await;
/// # }
/// ```
...
impl<'a> AccountLocationBatchGetReviewCall<'a> {
    ...
    /// Perform the operation you have build so far.
    pub async fn doit(mut self) -> client::Result<(hyper::Response<hyper::body::Body>, BatchGetReviewsResponse)> {
        use url::percent_encoding::{percent_encode, DEFAULT_ENCODE_SET};
        use std::io::{Read, Seek};
        use hyper::header::{CONTENT_TYPE, CONTENT_LENGTH, AUTHORIZATION, USER_AGENT, LOCATION};
        use client::ToParts;
        ...
        dlg.begin(client::MethodInfo { id: "mybusiness.accounts.locations.batchGetReviews",
                               http_method: hyper::Method::POST });
        let mut params: Vec<(&str, String)> = Vec::with_capacity(4 + self._additional_params.len());
        params.push(("name", self._name.to_string()));
        for &field in ["alt", "name"].iter() {
        ...
        let mut url = self.hub._base_url.clone() + "v4/{+name}/locations:batchGetReviews";
...
/// operation is only valid if the location is unverified.
///
/// A builder for the *locations.clearAssociation* method supported by a *account* resource.
/// It is not used directly, but through a `AccountMethods` instance.
///
/// # Example
///
...
/// # extern crate hyper_rustls;
/// # extern crate google_mybusiness4 as mybusiness4;
/// use mybusiness4::api::ClearLocationAssociationRequest;
/// # async fn dox() {
/// # use std::default::Default;
/// # use mybusiness4::{MyBusiness, oauth2, hyper, hyper_rustls};
/// 
...
/// // execute the final call using `doit()`.
/// // Values shown here are possibly random and not representative !
/// let result = hub.accounts().locations_clear_association(req, "name")
///              .doit().await;
/// # }
/// ```
...
impl<'a> AccountLocationClearAssociationCall<'a> {
    ...
    pub async fn doit(mut self) -> client::Result<(hyper::Response<hyper::body::Body>, Empty)> {
        ...
        dlg.begin(client::MethodInfo { id: "mybusiness.accounts.locations.clearAssociation",
                               http_method: hyper::Method::POST });
        let mut params: Vec<(&str, String)> = Vec::with_capacity(4 + self._additional_params.len());
        params.push(("name", self._name.to_string()));
        for &field in ["alt", "name"].iter() {
        ...
        let mut url = self.hub._base_url.clone() + "v4/{+name}:clearAssociation";
...
impl<'a> AccountLocationCreateCall<'a> {
    ...
    pub async fn doit(mut self) -> client::Result<(hyper::Response<hyper::body::Body>, Location)> {
        ...
        dlg.begin(client::MethodInfo { id: "mybusiness.accounts.locations.create",
                               http_method: hyper::Method::POST });
        let mut params: Vec<(&str, String)> = Vec::with_capacity(6 + self._additional_params.len());
        params.push(("parent", self._parent.to_string()));
...
/// Returns `NOT_FOUND` if the location does not exist.
///
/// A builder for the *locations.delete* method supported by a *account* resource.
/// It is not used directly, but through a `AccountMethods` instance.
///
/// # Example
///
...
/// // execute the final call using `doit()`.
/// // Values shown here are possibly random and not representative !
/// let result = hub.accounts().locations_delete("name")
///              .doit().await;
/// # }
/// ```
...
impl<'a> AccountLocationDeleteCall<'a> {
    ...
    pub async fn doit(mut self) -> client::Result<(hyper::Response<hyper::body::Body>, Empty)> {
        ...
        dlg.begin(client::MethodInfo { id: "mybusiness.accounts.locations.delete",
                               http_method: hyper::Method::DELETE });
        let mut params: Vec<(&str, String)> = Vec::with_capacity(3 + self._additional_params.len());
        params.push(("name", self._name.to_string()));
        for &field in ["alt", "name"].iter() {
...
/// language.
///
/// A builder for the *locations.fetchVerificationOptions* method supported by a *account* resource.
/// It is not used directly, but through a `AccountMethods` instance.
///
/// # Example
///
...
/// # extern crate hyper_rustls;
/// # extern crate google_mybusiness4 as mybusiness4;
/// use mybusiness4::api::FetchVerificationOptionsRequest;
/// # async fn dox() {
/// # use std::default::Default;
/// # use mybusiness4::{MyBusiness, oauth2, hyper, hyper_rustls};
/// 
...
/// // into the respective structure. Some of the parts shown here might not be applicable !
/// // Values shown here are possibly random and not representative !
/// let mut req = FetchVerificationOptionsRequest::default();
/// 
/// // You can configure optional parameters by calling the respective setters at will, and
/// // execute the final call using `doit()`.
/// // Values shown here are possibly random and not representative !
/// let result = hub.accounts().locations_fetch_verification_options(req, "name")
///              .doit().await;
/// # }
/// ```
...
impl<'a> AccountLocationFetchVerificationOptionCall<'a> {
    ...
    /// Perform the operation you have build so far.
    pub async fn doit(mut self) -> client::Result<(hyper::Response<hyper::body::Body>, FetchVerificationOptionsResponse)> {
        use url::percent_encoding::{percent_encode, DEFAULT_ENCODE_SET};
        use std::io::{Read, Seek};
        use hyper::header::{CONTENT_TYPE, CONTENT_LENGTH, AUTHORIZATION, USER_AGENT, LOCATION};
        use client::ToParts;
        ...
        dlg.begin(client::MethodInfo { id: "mybusiness.accounts.locations.fetchVerificationOptions",
                               http_method: hyper::Method::POST });
        let mut params: Vec<(&str, String)> = Vec::with_capacity(4 + self._additional_params.len());
        params.push(("name", self._name.to_string()));
        for &field in ["alt", "name"].iter() {
        ...
        let mut url = self.hub._base_url.clone() + "v4/{+name}:fetchVerificationOptions";
...
/// location. This operation is only valid if the location is unverified.
///
/// A builder for the *locations.findMatches* method supported by a *account* resource.
/// It is not used directly, but through a `AccountMethods` instance.
///
/// # Example
///
...
/// # extern crate hyper_rustls;
/// # extern crate google_mybusiness4 as mybusiness4;
/// use mybusiness4::api::FindMatchingLocationsRequest;
/// # async fn dox() {
/// # use std::default::Default;
/// # use mybusiness4::{MyBusiness, oauth2, hyper, hyper_rustls};
/// 
...
/// // into the respective structure. Some of the parts shown here might not be applicable !
/// // Values shown here are possibly random and not representative !
/// let mut req = FindMatchingLocationsRequest::default();
/// 
/// // You can configure optional parameters by calling the respective setters at will, and
/// // execute the final call using `doit()`.
/// // Values shown here are possibly random and not representative !
/// let result = hub.accounts().locations_find_matches(req, "name")
///              .doit().await;
/// # }
/// ```
...
impl<'a> AccountLocationFindMatcheCall<'a> {
    ...
    /// Perform the operation you have build so far.
    pub async fn doit(mut self) -> client::Result<(hyper::Response<hyper::body::Body>, FindMatchingLocationsResponse)> {
        use url::percent_encoding::{percent_encode, DEFAULT_ENCODE_SET};
        use std::io::{Read, Seek};
        use hyper::header::{CONTENT_TYPE, CONTENT_LENGTH, AUTHORIZATION, USER_AGENT, LOCATION};
        use client::ToParts;
        ...
        dlg.begin(client::MethodInfo { id: "mybusiness.accounts.locations.findMatches",
                               http_method: hyper::Method::POST });
        let mut params: Vec<(&str, String)> = Vec::with_capacity(4 + self._additional_params.len());
        params.push(("name", self._name.to_string()));
        for &field in ["alt", "name"].iter() {
        ...
        let mut url = self.hub._base_url.clone() + "v4/{+name}:findMatches";
...
/// location does not exist.
///
/// A builder for the *locations.get* method supported by a *account* resource.
/// It is not used directly, but through a `AccountMethods` instance.
///
/// # Example
///
...
/// // execute the final call using `doit()`.
/// // Values shown here are possibly random and not representative !
/// let result = hub.accounts().locations_get("name")
///              .doit().await;
/// # }
/// ```
...
impl<'a> AccountLocationGetCall<'a> {
    ...
    pub async fn doit(mut self) -> client::Result<(hyper::Response<hyper::body::Body>, Location)> {
        ...
        dlg.begin(client::MethodInfo { id: "mybusiness.accounts.locations.get",
                               http_method: hyper::Method::GET });
        let mut params: Vec<(&str, String)> = Vec::with_capacity(3 + self._additional_params.len());
        params.push(("name", self._name.to_string()));
        for &field in ["alt", "name"].iter() {
...
/// Returns `NOT_FOUND` if the location does not exist.
///
/// A builder for the *locations.getGoogleUpdated* method supported by a *account* resource.
/// It is not used directly, but through a `AccountMethods` instance.
///
/// # Example
///
...
/// // execute the final call using `doit()`.
/// // Values shown here are possibly random and not representative !
/// let result = hub.accounts().locations_get_google_updated("name")
///              .doit().await;
/// # }
/// ```
...
impl<'a> AccountLocationGetGoogleUpdatedCall<'a> {
    ...
    pub async fn doit(mut self) -> client::Result<(hyper::Response<hyper::body::Body>, GoogleUpdatedLocation)> {
        ...
        dlg.begin(client::MethodInfo { id: "mybusiness.accounts.locations.getGoogleUpdated",
                               http_method: hyper::Method::GET });
        let mut params: Vec<(&str, String)> = Vec::with_capacity(3 + self._additional_params.len());
        params.push(("name", self._name.to_string()));
        for &field in ["alt", "name"].iter() {
        ...
        let mut url = self.hub._base_url.clone() + "v4/{+name}:googleUpdated";
...
impl<'a> AccountLocationListCall<'a> {
    ...
    pub async fn doit(mut self) -> client::Result<(hyper::Response<hyper::body::Body>, ListLocationsResponse)> {
        ...
        dlg.begin(client::MethodInfo { id: "mybusiness.accounts.locations.list",
                               http_method: hyper::Method::GET });
        let mut params: Vec<(&str, String)> = Vec::with_capacity(8 + self._additional_params.len());
        params.push(("parent", self._parent.to_string()));
        if let Some(value) = self._page_token {
...
/// Returns `NOT_FOUND` if the location does not exist.
///
/// A builder for the *locations.patch* method supported by a *account* resource.
/// It is not used directly, but through a `AccountMethods` instance.
///
/// # Example
///
...
/// // execute the final call using `doit()`.
/// // Values shown here are possibly random and not representative !
/// let result = hub.accounts().locations_patch(req, "name")
///              .validate_only(true)
///              .update_mask("sit")
///              .attribute_mask("et")
///              .doit().await;
...
impl<'a> AccountLocationPatchCall<'a> {
    ...
    pub async fn doit(mut self) -> client::Result<(hyper::Response<hyper::body::Body>, Location)> {
        ...
        dlg.begin(client::MethodInfo { id: "mybusiness.accounts.locations.patch",
                               http_method: hyper::Method::PATCH });
        ...
        for &field in ["alt", "name", "validateOnly", "updateMask", "attributeMask"].iter() {
            if self._additional_params.contains_key(field) {
                dlg.finished(false);
                return Err(client::Error::FieldClash(field));
            }
...
/// to a batch size of 10 `location_names` per call.</aside>
///
/// A builder for the *locations.reportInsights* method supported by a *account* resource.
/// It is not used directly, but through a `AccountMethods` instance.
///
/// # Example
///
...
/// # extern crate hyper_rustls;
/// # extern crate google_mybusiness4 as mybusiness4;
/// use mybusiness4::api::ReportLocationInsightsRequest;
/// # async fn dox() {
/// # use std::default::Default;
/// # use mybusiness4::{MyBusiness, oauth2, hyper, hyper_rustls};
/// 
...
/// // into the respective structure. Some of the parts shown here might not be applicable !
/// // Values shown here are possibly random and not representative !
/// let mut req = ReportLocationInsightsRequest::default();
/// 
/// // You can configure optional parameters by calling the respective setters at will, and
/// // execute the final call using `doit()`.
/// // Values shown here are possibly random and not representative !
/// let result = hub.accounts().locations_report_insights(req, "name")
///              .doit().await;
/// # }
/// ```
...
impl<'a> AccountLocationReportInsightCall<'a> {
    ...
    /// Perform the operation you have build so far.
    pub async fn doit(mut self) -> client::Result<(hyper::Response<hyper::body::Body>, ReportLocationInsightsResponse)> {
        use url::percent_encoding::{percent_encode, DEFAULT_ENCODE_SET};
        use std::io::{Read, Seek};
        use hyper::header::{CONTENT_TYPE, CONTENT_LENGTH, AUTHORIZATION, USER_AGENT, LOCATION};
        use client::ToParts;
        ...
        dlg.begin(client::MethodInfo { id: "mybusiness.accounts.locations.reportInsights",
                               http_method: hyper::Method::POST });
        let mut params: Vec<(&str, String)> = Vec::with_capacity(4 + self._additional_params.len());
        params.push(("name", self._name.to_string()));
        for &field in ["alt", "name"].iter() {
        ...
        let mut url = self.hub._base_url.clone() + "v4/{+name}/locations:reportInsights";
...
/// # extern crate hyper_rustls;
/// # extern crate google_mybusiness4 as mybusiness4;
/// use mybusiness4::api::TransferLocationRequest;
/// # async fn dox() {
/// # use std::default::Default;
/// # use mybusiness4::{MyBusiness, oauth2, hyper, hyper_rustls};
/// 
...
impl<'a> AccountLocationTransferCall<'a> {
    ...
    pub async fn doit(mut self) -> client::Result<(hyper::Response<hyper::body::Body>, Location)> {
        ...
        dlg.begin(client::MethodInfo { id: "mybusiness.accounts.locations.transfer",
                               http_method: hyper::Method::POST });
        let mut params: Vec<(&str, String)> = Vec::with_capacity(4 + self._additional_params.len());
        params.push(("name", self._name.to_string()));
        for &field in ["alt", "name"].iter() {
...
/// Starts the verification process for a location.
///
/// A builder for the *locations.verify* method supported by a *account* resource.
/// It is not used directly, but through a `AccountMethods` instance.
///
/// # Example
///
...
/// # extern crate hyper_rustls;
/// # extern crate google_mybusiness4 as mybusiness4;
/// use mybusiness4::api::VerifyLocationRequest;
/// # async fn dox() {
/// # use std::default::Default;
/// # use mybusiness4::{MyBusiness, oauth2, hyper, hyper_rustls};
/// 
...
/// // execute the final call using `doit()`.
/// // Values shown here are possibly random and not representative !
/// let result = hub.accounts().locations_verify(req, "name")
///              .doit().await;
/// # }
/// ```
...
impl<'a> AccountLocationVerifyCall<'a> {
    ...
    /// Perform the operation you have build so far.
    pub async fn doit(mut self) -> client::Result<(hyper::Response<hyper::body::Body>, VerifyLocationResponse)> {
        use url::percent_encoding::{percent_encode, DEFAULT_ENCODE_SET};
        use std::io::{Read, Seek};
        use hyper::header::{CONTENT_TYPE, CONTENT_LENGTH, AUTHORIZATION, USER_AGENT, LOCATION};
        use client::ToParts;
        ...
        dlg.begin(client::MethodInfo { id: "mybusiness.accounts.locations.verify",
                               http_method: hyper::Method::POST });
        let mut params: Vec<(&str, String)> = Vec::with_capacity(4 + self._additional_params.len());
        params.push(("name", self._name.to_string()));
        for &field in ["alt", "name"].iter() {
        ...
        let mut url = self.hub._base_url.clone() + "v4/{+name}:verify";
...
/// </ul>
///
/// A builder for the *create* method supported by a *account* resource.
/// It is not used directly, but through a `AccountMethods` instance.
///
/// # Example
///
...
/// // execute the final call using `doit()`.
/// // Values shown here are possibly random and not representative !
/// let result = hub.accounts().create(req)
///              .primary_owner("et")
///              .doit().await;
/// # }
/// ```
...
impl<'a> AccountCreateCall<'a> {
    ...
    pub async fn doit(mut self) -> client::Result<(hyper::Response<hyper::body::Body>, Account)> {
        ...
        dlg.begin(client::MethodInfo { id: "mybusiness.accounts.create",
                               http_method: hyper::Method::POST });
        let mut params: Vec<(&str, String)> = Vec::with_capacity(4 + self._additional_params.len());
        if let Some(value) = self._primary_owner {
            params.push(("primaryOwner", value.to_string()));
        }
        for &field in ["alt", "primaryOwner"].iter() {
            if self._additional_params.contains_key(field) {
                dlg.finished(false);
                return Err(client::Error::FieldClash(field));
            }
        ...
        let mut url = self.hub._base_url.clone() + "v4/accounts";
...
/// Clears the pubsub notification settings for the account.
///
/// A builder for the *deleteNotifications* method supported by a *account* resource.
/// It is not used directly, but through a `AccountMethods` instance.
///
/// # Example
///
...
/// // execute the final call using `doit()`.
/// // Values shown here are possibly random and not representative !
/// let result = hub.accounts().delete_notifications("name")
///              .doit().await;
/// # }
/// ```
...
impl<'a> AccountDeleteNotificationCall<'a> {
    ...
    pub async fn doit(mut self) -> client::Result<(hyper::Response<hyper::body::Body>, Empty)> {
        ...
        dlg.begin(client::MethodInfo { id: "mybusiness.accounts.deleteNotifications",
                               http_method: hyper::Method::DELETE });
        let mut params: Vec<(&str, String)> = Vec::with_capacity(3 + self._additional_params.len());
        params.push(("name", self._name.to_string()));
        for &field in ["alt", "name"].iter() {
...
/// account number when it is required.
///
/// A builder for the *generateAccountNumber* method supported by a *account* resource.
/// It is not used directly, but through a `AccountMethods` instance.
///
/// # Example
///
...
/// # extern crate hyper_rustls;
/// # extern crate google_mybusiness4 as mybusiness4;
/// use mybusiness4::api::GenerateAccountNumberRequest;
/// # async fn dox() {
/// # use std::default::Default;
/// # use mybusiness4::{MyBusiness, oauth2, hyper, hyper_rustls};
/// 
...
/// // into the respective structure. Some of the parts shown here might not be applicable !
/// // Values shown here are possibly random and not representative !
/// let mut req = GenerateAccountNumberRequest::default();
/// 
/// // You can configure optional parameters by calling the respective setters at will, and
/// // execute the final call using `doit()`.
/// // Values shown here are possibly random and not representative !
/// let result = hub.accounts().generate_account_number(req, "name")
///              .doit().await;
/// # }
/// ```
...
impl<'a> AccountGenerateAccountNumberCall<'a> {
    ...
    pub async fn doit(mut self) -> client::Result<(hyper::Response<hyper::body::Body>, Account)> {
        ...
        dlg.begin(client::MethodInfo { id: "mybusiness.accounts.generateAccountNumber",
                               http_method: hyper::Method::POST });
        let mut params: Vec<(&str, String)> = Vec::with_capacity(4 + self._additional_params.len());
        params.push(("name", self._name.to_string()));
        for &field in ["alt", "name"].iter() {
        ...
        let mut url = self.hub._base_url.clone() + "v4/{+name}:generateAccountNumber";
...
impl<'a> AccountGetCall<'a> {
    ...
    pub async fn doit(mut self) -> client::Result<(hyper::Response<hyper::body::Body>, Account)> {
        ...
        dlg.begin(client::MethodInfo { id: "mybusiness.accounts.get",
                               http_method: hyper::Method::GET });
        let mut params: Vec<(&str, String)> = Vec::with_capacity(3 + self._additional_params.len());
        params.push(("name", self._name.to_string()));
        for &field in ["alt", "name"].iter() {
...
/// Returns the pubsub notification settings for the account.
///
/// A builder for the *getNotifications* method supported by a *account* resource.
/// It is not used directly, but through a `AccountMethods` instance.
///
/// # Example
///
...
/// // execute the final call using `doit()`.
/// // Values shown here are possibly random and not representative !
/// let result = hub.accounts().get_notifications("name")
///              .doit().await;
/// # }
/// ```
...
impl<'a> AccountGetNotificationCall<'a> {
    ...
    pub async fn doit(mut self) -> client::Result<(hyper::Response<hyper::body::Body>, Notifications)> {
        ...
        dlg.begin(client::MethodInfo { id: "mybusiness.accounts.getNotifications",
                               http_method: hyper::Method::GET });
        let mut params: Vec<(&str, String)> = Vec::with_capacity(3 + self._additional_params.len());
        params.push(("name", self._name.to_string()));
        for &field in ["alt", "name"].iter() {
...
impl<'a> AccountListCall<'a> {
    ...
    pub async fn doit(mut self) -> client::Result<(hyper::Response<hyper::body::Body>, ListAccountsResponse)> {
        ...
        dlg.begin(client::MethodInfo { id: "mybusiness.accounts.list",
                               http_method: hyper::Method::GET });
        let mut params: Vec<(&str, String)> = Vec::with_capacity(6 + self._additional_params.len());
        if let Some(value) = self._page_token {
            params.push(("pageToken", value.to_string()));
...
impl<'a> AccountListRecommendGoogleLocationCall<'a> {
    ...
    /// Perform the operation you have build so far.
    pub async fn doit(mut self) -> client::Result<(hyper::Response<hyper::body::Body>, ListRecommendedGoogleLocationsResponse)> {
        use url::percent_encoding::{percent_encode, DEFAULT_ENCODE_SET};
        use std::io::{Read, Seek};
        use hyper::header::{CONTENT_TYPE, CONTENT_LENGTH, AUTHORIZATION, USER_AGENT, LOCATION};
        use client::ToParts;
        ...
        dlg.begin(client::MethodInfo { id: "mybusiness.accounts.listRecommendGoogleLocations",
                               http_method: hyper::Method::GET });
        let mut params: Vec<(&str, String)> = Vec::with_capacity(5 + self._additional_params.len());
        params.push(("name", self._name.to_string()));
        if let Some(value) = self._page_token {
...
/// // execute the final call using `doit()`.
/// // Values shown here are possibly random and not representative !
/// let result = hub.accounts().update(req, "name")
///              .validate_only(false)
///              .doit().await;
/// # }
/// ```
...
impl<'a> AccountUpdateCall<'a> {
    ...
    pub async fn doit(mut self) -> client::Result<(hyper::Response<hyper::body::Body>, Account)> {
        ...
        dlg.begin(client::MethodInfo { id: "mybusiness.accounts.update",
                               http_method: hyper::Method::PUT });
        let mut params: Vec<(&str, String)> = Vec::with_capacity(5 + self._additional_params.len());
        params.push(("name", self._name.to_string()));
        if let Some(value) = self._validate_only {
...
/// pubsub topic can be set.
///
/// A builder for the *updateNotifications* method supported by a *account* resource.
/// It is not used directly, but through a `AccountMethods` instance.
///
/// # Example
///
...
/// # extern crate hyper_rustls;
/// # extern crate google_mybusiness4 as mybusiness4;
/// use mybusiness4::api::Notifications;
/// # async fn dox() {
/// # use std::default::Default;
/// # use mybusiness4::{MyBusiness, oauth2, hyper, hyper_rustls};
/// 
...
/// // into the respective structure. Some of the parts shown here might not be applicable !
/// // Values shown here are possibly random and not representative !
/// let mut req = Notifications::default();
/// 
/// // You can configure optional parameters by calling the respective setters at will, and
/// // execute the final call using `doit()`.
/// // Values shown here are possibly random and not representative !
/// let result = hub.accounts().update_notifications(req, "name")
///              .doit().await;
/// # }
/// ```
...
impl<'a> AccountUpdateNotificationCall<'a> {
    ...
    pub async fn doit(mut self) -> client::Result<(hyper::Response<hyper::body::Body>, Notifications)> {
        ...
        dlg.begin(client::MethodInfo { id: "mybusiness.accounts.updateNotifications",
                               http_method: hyper::Method::PUT });
        let mut params: Vec<(&str, String)> = Vec::with_capacity(4 + self._additional_params.len());
        params.push(("name", self._name.to_string()));
        for &field in ["alt", "name"].iter() {
...
impl<'a> AttributeListCall<'a> {
    ...
    pub async fn doit(mut self) -> client::Result<(hyper::Response<hyper::body::Body>, ListAttributeMetadataResponse)> {
        ...
        dlg.begin(client::MethodInfo { id: "mybusiness.attributes.list",
                               http_method: hyper::Method::GET });
        let mut params: Vec<(&str, String)> = Vec::with_capacity(8 + self._additional_params.len());
        if let Some(value) = self._page_token {
            params.push(("pageToken", value.to_string()));
        ...
        for &field in ["alt", "pageToken", "pageSize", "name", "languageCode", "country", "categoryId"].iter() {
            if self._additional_params.contains_key(field) {
                dlg.finished(false);
                return Err(client::Error::FieldClash(field));
            }
        ...
        let mut url = self.hub._base_url.clone() + "v4/attributes";
...
impl<'a> CategoryListCall<'a> {
    ...
    /// Perform the operation you have build so far.
    pub async fn doit(mut self) -> client::Result<(hyper::Response<hyper::body::Body>, ListBusinessCategoriesResponse)> {
        use std::io::{Read, Seek};
        use hyper::header::{CONTENT_TYPE, CONTENT_LENGTH, AUTHORIZATION, USER_AGENT, LOCATION};
        use client::ToParts;
        let mut dd = client::DefaultDelegate;
        ...
        dlg.begin(client::MethodInfo { id: "mybusiness.categories.list",
                               http_method: hyper::Method::GET });
        let mut params: Vec<(&str, String)> = Vec::with_capacity(7 + self._additional_params.len());
        if let Some(value) = self._search_term {
            params.push(("searchTerm", value.to_string()));
        }
        ...
        for &field in ["alt", "searchTerm", "regionCode", "pageToken", "pageSize", "languageCode"].iter() {
            if self._additional_params.contains_key(field) {
                dlg.finished(false);
                return Err(client::Error::FieldClash(field));
            }
        ...
        let mut url = self.hub._base_url.clone() + "v4/categories";
...
impl<'a> ChainGetCall<'a> {
    ...
    pub async fn doit(mut self) -> client::Result<(hyper::Response<hyper::body::Body>, Chain)> {
        ...
        dlg.begin(client::MethodInfo { id: "mybusiness.chains.get",
                               http_method: hyper::Method::GET });
        let mut params: Vec<(&str, String)> = Vec::with_capacity(3 + self._additional_params.len());
        params.push(("name", self._name.to_string()));
        for &field in ["alt", "name"].iter() {
...
impl<'a> ChainSearchCall<'a> {
    ...
    pub async fn doit(mut self) -> client::Result<(hyper::Response<hyper::body::Body>, SearchChainsResponse)> {
        ...
        dlg.begin(client::MethodInfo { id: "mybusiness.chains.search",
                               http_method: hyper::Method::GET });
        let mut params: Vec<(&str, String)> = Vec::with_capacity(4 + self._additional_params.len());
        if let Some(value) = self._result_count {
            params.push(("resultCount", value.to_string()));
        }
        if let Some(value) = self._chain_display_name {
            params.push(("chainDisplayName", value.to_string()));
        }
        for &field in ["alt", "resultCount", "chainDisplayName"].iter() {
            if self._additional_params.contains_key(field) {
                dlg.finished(false);
                return Err(client::Error::FieldClash(field));
            }
        ...
        let mut url = self.hub._base_url.clone() + "v4/chains:search";
...
/// Report a GoogleLocation.
///
/// A builder for the *report* method supported by a *googleLocation* resource.
...
/// # extern crate hyper_rustls;
/// # extern crate google_mybusiness4 as mybusiness4;
/// use mybusiness4::api::ReportGoogleLocationRequest;
/// # async fn dox() {
/// # use std::default::Default;
/// # use mybusiness4::{MyBusiness, oauth2, hyper, hyper_rustls};
/// 
...
/// // into the respective structure. Some of the parts shown here might not be applicable !
/// // Values shown here are possibly random and not representative !
/// let mut req = ReportGoogleLocationRequest::default();
/// 
/// // You can configure optional parameters by calling the respective setters at will, and
/// // execute the final call using `doit()`.
/// // Values shown here are possibly random and not representative !
/// let result = hub.google_locations().report(req, "name")
///              .doit().await;
/// # }
/// ```
...
impl<'a> GoogleLocationReportCall<'a> {
    ...
    pub async fn doit(mut self) -> client::Result<(hyper::Response<hyper::body::Body>, Empty)> {
        ...
        dlg.begin(client::MethodInfo { id: "mybusiness.googleLocations.report",
                               http_method: hyper::Method::POST });
        let mut params: Vec<(&str, String)> = Vec::with_capacity(4 + self._additional_params.len());
        params.push(("name", self._name.to_string()));
        for &field in ["alt", "name"].iter() {
        ...
        let mut url = self.hub._base_url.clone() + "v4/{+name}:report";
...
/// # extern crate hyper_rustls;
/// # extern crate google_mybusiness4 as mybusiness4;
/// use mybusiness4::api::SearchGoogleLocationsRequest;
/// # async fn dox() {
/// # use std::default::Default;
/// # use mybusiness4::{MyBusiness, oauth2, hyper, hyper_rustls};
/// 
...
impl<'a> GoogleLocationSearchCall<'a> {
    ...
    pub async fn doit(mut self) -> client::Result<(hyper::Response<hyper::body::Body>, SearchGoogleLocationsResponse)> {
        ...
        dlg.begin(client::MethodInfo { id: "mybusiness.googleLocations.search",
                               http_method: hyper::Method::POST });
        let mut params: Vec<(&str, String)> = Vec::with_capacity(3 + self._additional_params.len());
        ...
        let mut url = self.hub._base_url.clone() + "v4/googleLocations:search";
...
/// # extern crate hyper_rustls;
/// # extern crate google_mybusiness4 as mybusiness4;
/// use mybusiness4::api::GenerateVerificationTokenRequest;
/// # async fn dox() {
/// # use std::default::Default;
/// # use mybusiness4::{MyBusiness, oauth2, hyper, hyper_rustls};
/// 
...
impl<'a> VerificationTokenGenerateCall<'a> {
    ...
    pub async fn doit(mut self) -> client::Result<(hyper::Response<hyper::body::Body>, GenerateVerificationTokenResponse)> {
        ...
        dlg.begin(client::MethodInfo { id: "mybusiness.verificationTokens.generate",
                               http_method: hyper::Method::POST });
        let mut params: Vec<(&str, String)> = Vec::with_capacity(3 + self._additional_params.len());
        for &field in ["alt"].iter() {
            if self._additional_params.contains_key(field) {
        ...
        let mut url = self.hub._base_url.clone() + "v4/verificationTokens:generate";
