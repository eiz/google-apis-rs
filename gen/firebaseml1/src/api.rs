...
/// Central instance to access all FirebaseML related resource activities
///
/// # Examples
///
...
impl<'a, > FirebaseML<> {
    ...
    /// It defaults to `https://firebaseml.googleapis.com/`.
    ///
...
/// # extern crate hyper_rustls;
/// # extern crate google_firebaseml1 as firebaseml1;
/// use firebaseml1::api::CancelOperationRequest;
/// # async fn dox() {
/// # use std::default::Default;
/// # use firebaseml1::{FirebaseML, oauth2, hyper, hyper_rustls};
/// 
...
impl<'a> OperationCancelCall<'a> {
    ...
    pub async fn doit(mut self) -> client::Result<(hyper::Response<hyper::body::Body>, Empty)> {
        ...
        dlg.begin(client::MethodInfo { id: "firebaseml.operations.cancel",
...
impl<'a> OperationDeleteCall<'a> {
    ...
    pub async fn doit(mut self) -> client::Result<(hyper::Response<hyper::body::Body>, Empty)> {
        ...
        dlg.begin(client::MethodInfo { id: "firebaseml.operations.delete",
...
impl<'a> OperationListCall<'a> {
    ...
    pub async fn doit(mut self) -> client::Result<(hyper::Response<hyper::body::Body>, ListOperationsResponse)> {
        ...
        dlg.begin(client::MethodInfo { id: "firebaseml.operations.list",
