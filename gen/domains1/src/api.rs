...
/// # extern crate hyper_rustls;
/// # extern crate google_domains1 as domains1;
/// use domains1::api::ConfigureContactSettingsRequest;
/// # async fn dox() {
/// # use std::default::Default;
/// # use domains1::{CloudDomains, oauth2, hyper, hyper_rustls};
/// 
...
impl<'a> ProjectLocationRegistrationConfigureContactSettingCall<'a> {
    ...
    pub async fn doit(mut self) -> client::Result<(hyper::Response<hyper::body::Body>, Operation)> {
        ...
        let mut url = self.hub._base_url.clone() + "v1/{+registration}:configureContactSettings";
        if self._scopes.len() == 0 {
            self._scopes.insert(Scope::CloudPlatform.as_ref().to_string(), ());
        }
...
/// # extern crate hyper_rustls;
/// # extern crate google_domains1 as domains1;
/// use domains1::api::ConfigureDnsSettingsRequest;
/// # async fn dox() {
/// # use std::default::Default;
/// # use domains1::{CloudDomains, oauth2, hyper, hyper_rustls};
/// 
...
impl<'a> ProjectLocationRegistrationConfigureDnsSettingCall<'a> {
    ...
    pub async fn doit(mut self) -> client::Result<(hyper::Response<hyper::body::Body>, Operation)> {
        ...
        let mut url = self.hub._base_url.clone() + "v1/{+registration}:configureDnsSettings";
        if self._scopes.len() == 0 {
            self._scopes.insert(Scope::CloudPlatform.as_ref().to_string(), ());
        }
...
/// # extern crate hyper_rustls;
/// # extern crate google_domains1 as domains1;
/// use domains1::api::ConfigureManagementSettingsRequest;
/// # async fn dox() {
/// # use std::default::Default;
/// # use domains1::{CloudDomains, oauth2, hyper, hyper_rustls};
/// 
...
impl<'a> ProjectLocationRegistrationConfigureManagementSettingCall<'a> {
    ...
    pub async fn doit(mut self) -> client::Result<(hyper::Response<hyper::body::Body>, Operation)> {
        ...
        let mut url = self.hub._base_url.clone() + "v1/{+registration}:configureManagementSettings";
        if self._scopes.len() == 0 {
            self._scopes.insert(Scope::CloudPlatform.as_ref().to_string(), ());
        }
...
/// # extern crate hyper_rustls;
/// # extern crate google_domains1 as domains1;
/// use domains1::api::ExportRegistrationRequest;
/// # async fn dox() {
/// # use std::default::Default;
/// # use domains1::{CloudDomains, oauth2, hyper, hyper_rustls};
/// 
...
impl<'a> ProjectLocationRegistrationListCall<'a> {
    ...
    pub async fn doit(mut self) -> client::Result<(hyper::Response<hyper::body::Body>, ListRegistrationsResponse)> {
        ...
        let mut url = self.hub._base_url.clone() + "v1/{+parent}/registrations";
        if self._scopes.len() == 0 {
            self._scopes.insert(Scope::CloudPlatform.as_ref().to_string(), ());
        }
...
/// # extern crate hyper_rustls;
/// # extern crate google_domains1 as domains1;
/// use domains1::api::RegisterDomainRequest;
/// # async fn dox() {
/// # use std::default::Default;
/// # use domains1::{CloudDomains, oauth2, hyper, hyper_rustls};
/// 
...
impl<'a> ProjectLocationRegistrationRegisterCall<'a> {
    ...
    pub async fn doit(mut self) -> client::Result<(hyper::Response<hyper::body::Body>, Operation)> {
        ...
        let mut url = self.hub._base_url.clone() + "v1/{+parent}/registrations:register";
        if self._scopes.len() == 0 {
            self._scopes.insert(Scope::CloudPlatform.as_ref().to_string(), ());
        }
...
/// # extern crate hyper_rustls;
/// # extern crate google_domains1 as domains1;
/// use domains1::api::ResetAuthorizationCodeRequest;
/// # async fn dox() {
/// # use std::default::Default;
/// # use domains1::{CloudDomains, oauth2, hyper, hyper_rustls};
/// 
...
impl<'a> ProjectLocationRegistrationResetAuthorizationCodeCall<'a> {
    ...
    pub async fn doit(mut self) -> client::Result<(hyper::Response<hyper::body::Body>, AuthorizationCode)> {
        ...
        let mut url = self.hub._base_url.clone() + "v1/{+registration}:resetAuthorizationCode";
        if self._scopes.len() == 0 {
            self._scopes.insert(Scope::CloudPlatform.as_ref().to_string(), ());
        }
...
impl<'a> ProjectLocationRegistrationRetrieveAuthorizationCodeCall<'a> {
    ...
    pub async fn doit(mut self) -> client::Result<(hyper::Response<hyper::body::Body>, AuthorizationCode)> {
        ...
        let mut url = self.hub._base_url.clone() + "v1/{+registration}:retrieveAuthorizationCode";
        if self._scopes.len() == 0 {
            self._scopes.insert(Scope::CloudPlatform.as_ref().to_string(), ());
        }
...
impl<'a> ProjectLocationRegistrationRetrieveRegisterParameterCall<'a> {
    ...
    pub async fn doit(mut self) -> client::Result<(hyper::Response<hyper::body::Body>, RetrieveRegisterParametersResponse)> {
        ...
        let mut url = self.hub._base_url.clone() + "v1/{+location}/registrations:retrieveRegisterParameters";
        if self._scopes.len() == 0 {
            self._scopes.insert(Scope::CloudPlatform.as_ref().to_string(), ());
        }
...
impl<'a> ProjectLocationRegistrationRetrieveTransferParameterCall<'a> {
    ...
    pub async fn doit(mut self) -> client::Result<(hyper::Response<hyper::body::Body>, RetrieveTransferParametersResponse)> {
        ...
        let mut url = self.hub._base_url.clone() + "v1/{+location}/registrations:retrieveTransferParameters";
        if self._scopes.len() == 0 {
            self._scopes.insert(Scope::CloudPlatform.as_ref().to_string(), ());
        }
...
impl<'a> ProjectLocationRegistrationSearchDomainCall<'a> {
    ...
    pub async fn doit(mut self) -> client::Result<(hyper::Response<hyper::body::Body>, SearchDomainsResponse)> {
        ...
        let mut url = self.hub._base_url.clone() + "v1/{+location}/registrations:searchDomains";
        if self._scopes.len() == 0 {
            self._scopes.insert(Scope::CloudPlatform.as_ref().to_string(), ());
        }
...
/// # extern crate hyper_rustls;
/// # extern crate google_domains1 as domains1;
/// use domains1::api::SetIamPolicyRequest;
/// # async fn dox() {
/// # use std::default::Default;
/// # use domains1::{CloudDomains, oauth2, hyper, hyper_rustls};
/// 
...
/// # extern crate hyper_rustls;
/// # extern crate google_domains1 as domains1;
/// use domains1::api::TestIamPermissionsRequest;
/// # async fn dox() {
/// # use std::default::Default;
/// # use domains1::{CloudDomains, oauth2, hyper, hyper_rustls};
/// 
...
/// # extern crate hyper_rustls;
/// # extern crate google_domains1 as domains1;
/// use domains1::api::TransferDomainRequest;
/// # async fn dox() {
/// # use std::default::Default;
/// # use domains1::{CloudDomains, oauth2, hyper, hyper_rustls};
/// 
...
impl<'a> ProjectLocationRegistrationTransferCall<'a> {
    ...
    pub async fn doit(mut self) -> client::Result<(hyper::Response<hyper::body::Body>, Operation)> {
        ...
        let mut url = self.hub._base_url.clone() + "v1/{+parent}/registrations:transfer";
        if self._scopes.len() == 0 {
            self._scopes.insert(Scope::CloudPlatform.as_ref().to_string(), ());
        }
