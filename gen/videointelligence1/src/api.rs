...
/// # async fn dox() {
/// use std::default::Default;
/// use videointelligence1::{CloudVideoIntelligence, oauth2, hyper, hyper_rustls};
/// 
...
/// // execute the final call using `doit()`.
/// // Values shown here are possibly random and not representative !
/// let result = hub.operations().projects_locations_operations_cancel("name")
///              .doit().await;
/// # }
/// ```
...
impl<'a> OperationProjectLocationOperationCancelCall<'a> {
    ...
    pub async fn doit(mut self) -> client::Result<(hyper::Response<hyper::body::Body>, GoogleProtobuf_Empty)> {
        ...
        dlg.begin(client::MethodInfo { id: "videointelligence.operations.projects.locations.operations.cancel",
...
/// Deletes a long-running operation. This method indicates that the client is no longer interested in the operation result. It does not cancel the operation. If the server doesn't support this method, it returns `google.rpc.Code.UNIMPLEMENTED`.
///
/// A builder for the *projects.locations.operations.delete* method supported by a *operation* resource.
/// It is not used directly, but through a `OperationMethods` instance.
///
/// # Example
///
...
/// // execute the final call using `doit()`.
/// // Values shown here are possibly random and not representative !
/// let result = hub.operations().projects_locations_operations_delete("name")
///              .doit().await;
/// # }
/// ```
...
impl<'a> OperationProjectLocationOperationDeleteCall<'a> {
    ...
    pub async fn doit(mut self) -> client::Result<(hyper::Response<hyper::body::Body>, GoogleProtobuf_Empty)> {
        ...
        dlg.begin(client::MethodInfo { id: "videointelligence.operations.projects.locations.operations.delete",
...
/// Gets the latest state of a long-running operation. Clients can use this method to poll the operation result at intervals as recommended by the API service.
///
/// A builder for the *projects.locations.operations.get* method supported by a *operation* resource.
/// It is not used directly, but through a `OperationMethods` instance.
///
/// # Example
///
...
impl<'a> OperationProjectLocationOperationGetCall<'a> {
    ...
    pub async fn doit(mut self) -> client::Result<(hyper::Response<hyper::body::Body>, GoogleLongrunning_Operation)> {
        ...
        dlg.begin(client::MethodInfo { id: "videointelligence.operations.projects.locations.operations.get",
...
impl<'a> ProjectLocationOperationCancelCall<'a> {
    ...
    pub async fn doit(mut self) -> client::Result<(hyper::Response<hyper::body::Body>, GoogleProtobuf_Empty)> {
        ...
        dlg.begin(client::MethodInfo { id: "videointelligence.projects.locations.operations.cancel",
                               http_method: hyper::Method::POST });
...
impl<'a> ProjectLocationOperationDeleteCall<'a> {
    ...
    pub async fn doit(mut self) -> client::Result<(hyper::Response<hyper::body::Body>, GoogleProtobuf_Empty)> {
        ...
        dlg.begin(client::MethodInfo { id: "videointelligence.projects.locations.operations.delete",
                               http_method: hyper::Method::DELETE });
        let mut params: Vec<(&str, String)> = Vec::with_capacity(3 + self._additional_params.len());
        params.push(("name", self._name.to_string()));
        for &field in ["alt", "name"].iter() {
...
impl<'a> ProjectLocationOperationGetCall<'a> {
    ...
    pub async fn doit(mut self) -> client::Result<(hyper::Response<hyper::body::Body>, GoogleLongrunning_Operation)> {
        ...
        dlg.begin(client::MethodInfo { id: "videointelligence.projects.locations.operations.get",
                               http_method: hyper::Method::GET });
        let mut params: Vec<(&str, String)> = Vec::with_capacity(3 + self._additional_params.len());
        params.push(("name", self._name.to_string()));
        for &field in ["alt", "name"].iter() {
...
impl<'a> ProjectLocationOperationListCall<'a> {
    ...
    /// Perform the operation you have build so far.
    pub async fn doit(mut self) -> client::Result<(hyper::Response<hyper::body::Body>, GoogleLongrunning_ListOperationsResponse)> {
        use url::percent_encoding::{percent_encode, DEFAULT_ENCODE_SET};
        use std::io::{Read, Seek};
        use hyper::header::{CONTENT_TYPE, CONTENT_LENGTH, AUTHORIZATION, USER_AGENT, LOCATION};
        use client::ToParts;
        ...
        dlg.begin(client::MethodInfo { id: "videointelligence.projects.locations.operations.list",
                               http_method: hyper::Method::GET });
...
/// # extern crate hyper_rustls;
/// # extern crate google_videointelligence1 as videointelligence1;
/// use videointelligence1::api::GoogleCloudVideointelligenceV1_AnnotateVideoRequest;
/// # async fn dox() {
/// # use std::default::Default;
/// # use videointelligence1::{CloudVideoIntelligence, oauth2, hyper, hyper_rustls};
/// 
...
impl<'a> VideoAnnotateCall<'a> {
    ...
    pub async fn doit(mut self) -> client::Result<(hyper::Response<hyper::body::Body>, GoogleLongrunning_Operation)> {
        ...
        let mut url = self.hub._base_url.clone() + "v1/videos:annotate";
        if self._scopes.len() == 0 {
            self._scopes.insert(Scope::CloudPlatform.as_ref().to_string(), ());
        }
