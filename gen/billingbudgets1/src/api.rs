...
/// 
/// * [budgets create billing accounts](BillingAccountBudgetCreateCall) (request|response)
/// * [budgets get billing accounts](BillingAccountBudgetGetCall) (response)
/// * [budgets patch billing accounts](BillingAccountBudgetPatchCall) (request|response)
/// 
...
impl client::RequestValue for GoogleCloudBillingBudgetsV1Budget {}
impl client::ResponseResult for GoogleCloudBillingBudgetsV1Budget {}
...
impl client::Part for GoogleCloudBillingBudgetsV1BudgetAmount {}
...
impl client::Part for GoogleCloudBillingBudgetsV1CustomPeriod {}
...
impl client::Part for GoogleCloudBillingBudgetsV1Filter {}
...
/// 
#[derive(Default, Clone, Debug, Serialize, Deserialize)]
pub struct GoogleCloudBillingBudgetsV1LastPeriodAmount { _never_set: Option<bool> }

impl client::Part for GoogleCloudBillingBudgetsV1LastPeriodAmount {}
...
impl client::ResponseResult for GoogleCloudBillingBudgetsV1ListBudgetsResponse {}
...
impl client::Part for GoogleCloudBillingBudgetsV1NotificationsRule {}
...
impl client::Part for GoogleCloudBillingBudgetsV1ThresholdRule {}
...
impl<'a> BillingAccountMethods<'a> {
    ...
    pub fn budgets_create(&self, request: GoogleCloudBillingBudgetsV1Budget, parent: &str) -> BillingAccountBudgetCreateCall<'a> {
    ...
    pub fn budgets_patch(&self, request: GoogleCloudBillingBudgetsV1Budget, name: &str) -> BillingAccountBudgetPatchCall<'a> {
...
pub struct BillingAccountBudgetCreateCall<'a>
    ...
    hub: &'a CloudBillingBudget<>,
    _request: GoogleCloudBillingBudgetsV1Budget,
    _parent: String,
...
impl<'a> BillingAccountBudgetCreateCall<'a> {
    ...
    pub async fn doit(mut self) -> client::Result<(hyper::Response<hyper::body::Body>, GoogleCloudBillingBudgetsV1Budget)> {
        ...
        dlg.begin(client::MethodInfo { id: "billingbudgets.billingAccounts.budgets.create",
        ...
        let mut url = self.hub._base_url.clone() + "v1/{+parent}/budgets";
        if self._scopes.len() == 0 {
            self._scopes.insert(Scope::CloudBilling.as_ref().to_string(), ());
        }
    ...
    pub fn request(mut self, new_value: GoogleCloudBillingBudgetsV1Budget) -> BillingAccountBudgetCreateCall<'a> {
...
impl<'a> BillingAccountBudgetDeleteCall<'a> {
    ...
    pub async fn doit(mut self) -> client::Result<(hyper::Response<hyper::body::Body>, GoogleProtobufEmpty)> {
        ...
        dlg.begin(client::MethodInfo { id: "billingbudgets.billingAccounts.budgets.delete",
...
impl<'a> BillingAccountBudgetGetCall<'a> {
    ...
    pub async fn doit(mut self) -> client::Result<(hyper::Response<hyper::body::Body>, GoogleCloudBillingBudgetsV1Budget)> {
        ...
        dlg.begin(client::MethodInfo { id: "billingbudgets.billingAccounts.budgets.get",
...
impl<'a> BillingAccountBudgetListCall<'a> {
    ...
    /// Perform the operation you have build so far.
    pub async fn doit(mut self) -> client::Result<(hyper::Response<hyper::body::Body>, GoogleCloudBillingBudgetsV1ListBudgetsResponse)> {
        use url::percent_encoding::{percent_encode, DEFAULT_ENCODE_SET};
        use std::io::{Read, Seek};
        use hyper::header::{CONTENT_TYPE, CONTENT_LENGTH, AUTHORIZATION, USER_AGENT, LOCATION};
        use client::ToParts;
...
impl<'a> BillingAccountBudgetPatchCall<'a> {
    ...
    pub async fn doit(mut self) -> client::Result<(hyper::Response<hyper::body::Body>, GoogleCloudBillingBudgetsV1Budget)> {
        ...
        dlg.begin(client::MethodInfo { id: "billingbudgets.billingAccounts.budgets.patch",
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn request(mut self, new_value: GoogleCloudBillingBudgetsV1Budget) -> BillingAccountBudgetPatchCall<'a> {
        self._request = new_value;
        self
    }
    /// Output only. Resource name of the budget. The resource name implies the scope of a budget. Values are of the form `billingAccounts/{billingAccountId}/budgets/{budgetId}`.
    ...
    pub fn update_mask(mut self, new_value: &str) -> BillingAccountBudgetPatchCall<'a> {
