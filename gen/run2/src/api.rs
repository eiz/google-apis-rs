...
pub struct GoogleCloudRunOpV2BinaryAuthorization {
...
impl client::Part for GoogleCloudRunOpV2BinaryAuthorization {}
...
/// 
#[derive(Default, Clone, Debug, Serialize, Deserialize)]
pub struct GoogleCloudRunOpV2CloudSqlInstance {
    /// The Cloud SQL instance connection names, as can be found in https://console.cloud.google.com/sql/instances. Visit https://cloud.google.com/sql/docs/mysql/connect-run for more information on how to connect Cloud SQL and Cloud Run. Format: {project}:{location}:{instance}
    pub connections: Option<Vec<String>>,
}

impl client::Part for GoogleCloudRunOpV2CloudSqlInstance {}
...
/// 
#[derive(Default, Clone, Debug, Serialize, Deserialize)]
pub struct GoogleCloudRunOpV2Condition {
    /// A reason for the domain mapping condition.
    #[serde(rename="domainMappingReason")]
    pub domain_mapping_reason: Option<String>,
...
impl client::Part for GoogleCloudRunOpV2Condition {}
...
/// 
#[derive(Default, Clone, Debug, Serialize, Deserialize)]
pub struct GoogleCloudRunOpV2Container {
    ...
    pub env: Option<Vec<GoogleCloudRunOpV2EnvVar>>,
    ...
    pub ports: Option<Vec<GoogleCloudRunOpV2ContainerPort>>,
    /// Compute Resource requirements by this container. More info: https://kubernetes.io/docs/concepts/storage/persistent-volumes#resources
    pub resources: Option<GoogleCloudRunOpV2ResourceRequirements>,
    /// Volume to mount into the container's filesystem.
    #[serde(rename="volumeMounts")]
    pub volume_mounts: Option<Vec<GoogleCloudRunOpV2VolumeMount>>,
}

impl client::Part for GoogleCloudRunOpV2Container {}
...
/// 
#[derive(Default, Clone, Debug, Serialize, Deserialize)]
pub struct GoogleCloudRunOpV2ContainerPort {
...
impl client::Part for GoogleCloudRunOpV2ContainerPort {}
...
/// 
#[derive(Default, Clone, Debug, Serialize, Deserialize)]
pub struct GoogleCloudRunOpV2EnvVar {
    ...
    pub value_source: Option<GoogleCloudRunOpV2EnvVarSource>,
}

impl client::Part for GoogleCloudRunOpV2EnvVar {}
...
/// 
#[derive(Default, Clone, Debug, Serialize, Deserialize)]
pub struct GoogleCloudRunOpV2EnvVarSource {
    /// Selects a secret and a specific version from Cloud Secret Manager.
    #[serde(rename="secretKeyRef")]
    pub secret_key_ref: Option<GoogleCloudRunOpV2SecretKeySelector>,
}

impl client::Part for GoogleCloudRunOpV2EnvVarSource {}
...
/// 
#[derive(Default, Clone, Debug, Serialize, Deserialize)]
pub struct GoogleCloudRunOpV2ListRevisionsResponse {
    ...
    pub revisions: Option<Vec<GoogleCloudRunOpV2Revision>>,
}

impl client::ResponseResult for GoogleCloudRunOpV2ListRevisionsResponse {}
...
/// 
#[derive(Default, Clone, Debug, Serialize, Deserialize)]
pub struct GoogleCloudRunOpV2ListServicesResponse {
    /// A token indicating there are more items than page_size. Use it in the next ListServices request to continue.
    #[serde(rename="nextPageToken")]
    pub next_page_token: Option<String>,
    /// The resulting list of Services.
    pub services: Option<Vec<GoogleCloudRunOpV2Service>>,
}

impl client::ResponseResult for GoogleCloudRunOpV2ListServicesResponse {}
...
/// 
#[derive(Default, Clone, Debug, Serialize, Deserialize)]
pub struct GoogleCloudRunOpV2ResourceRequirements {
...
impl client::Part for GoogleCloudRunOpV2ResourceRequirements {}
...
/// 
#[derive(Default, Clone, Debug, Serialize, Deserialize)]
pub struct GoogleCloudRunOpV2Revision {
    /// KRM-style annotations for the resource.
    pub annotations: Option<HashMap<String, String>>,
    /// Output only. The Condition of this Revision, containing its readiness status, and detailed error information in case it did not reach a serving state.
    pub conditions: Option<Vec<GoogleCloudRunOpV2Condition>>,
    ...
    pub containers: Option<Vec<GoogleCloudRunOpV2Container>>,
    ...
    pub scaling: Option<GoogleCloudRunOpV2RevisionScaling>,
    ...
    pub volumes: Option<Vec<GoogleCloudRunOpV2Volume>>,
    ...
    pub vpc_access: Option<GoogleCloudRunOpV2VpcAccess>,
}

impl client::ResponseResult for GoogleCloudRunOpV2Revision {}
...
/// 
#[derive(Default, Clone, Debug, Serialize, Deserialize)]
pub struct GoogleCloudRunOpV2RevisionScaling {
...
impl client::Part for GoogleCloudRunOpV2RevisionScaling {}
...
/// 
#[derive(Default, Clone, Debug, Serialize, Deserialize)]
pub struct GoogleCloudRunOpV2RevisionTemplate {
    /// KRM-style annotations for the resource.
    pub annotations: Option<HashMap<String, String>>,
...
impl client::Part for GoogleCloudRunOpV2RevisionTemplate {}
...
/// 
#[derive(Default, Clone, Debug, Serialize, Deserialize)]
pub struct GoogleCloudRunOpV2SecretKeySelector {
...
impl client::Part for GoogleCloudRunOpV2SecretKeySelector {}
...
/// 
#[derive(Default, Clone, Debug, Serialize, Deserialize)]
pub struct GoogleCloudRunOpV2SecretVolumeSource {
    ...
    pub items: Option<Vec<GoogleCloudRunOpV2VersionToPath>>,
    /// Required. The name of the secret in Cloud Secret Manager. Format: {secret} if the secret is in the same project. projects/{project}/secrets/{secret} if the secret is in a different project.
    pub secret: Option<String>,
}

impl client::Part for GoogleCloudRunOpV2SecretVolumeSource {}
...
pub struct GoogleCloudRunOpV2Service {
    ...
    pub template: Option<GoogleCloudRunOpV2RevisionTemplate>,
    ...
    pub terminal_condition: Option<GoogleCloudRunOpV2Condition>,
    /// Specifies how to distribute traffic over a collection of Revisions belonging to the Service. If traffic is empty or not provided, defaults to 100% traffic to the latest `Ready` Revision.
    pub traffic: Option<Vec<GoogleCloudRunOpV2TrafficTarget>>,
    ...
    pub traffic_statuses: Option<Vec<GoogleCloudRunOpV2TrafficTargetStatus>>,
...
impl client::RequestValue for GoogleCloudRunOpV2Service {}
impl client::ResponseResult for GoogleCloudRunOpV2Service {}
...
/// 
#[derive(Default, Clone, Debug, Serialize, Deserialize)]
pub struct GoogleCloudRunOpV2TrafficTarget {
...
impl client::Part for GoogleCloudRunOpV2TrafficTarget {}
...
/// 
#[derive(Default, Clone, Debug, Serialize, Deserialize)]
pub struct GoogleCloudRunOpV2TrafficTargetStatus {
...
impl client::Part for GoogleCloudRunOpV2TrafficTargetStatus {}
...
/// 
#[derive(Default, Clone, Debug, Serialize, Deserialize)]
pub struct GoogleCloudRunOpV2VersionToPath {
...
impl client::Part for GoogleCloudRunOpV2VersionToPath {}
...
/// 
#[derive(Default, Clone, Debug, Serialize, Deserialize)]
pub struct GoogleCloudRunOpV2Volume {
    /// For Cloud SQL volumes, contains the specific instances that should be mounted. Visit https://cloud.google.com/sql/docs/mysql/connect-run for more information on how to connect Cloud SQL and Cloud Run.
    #[serde(rename="cloudSqlInstance")]
    pub cloud_sql_instance: Option<GoogleCloudRunOpV2CloudSqlInstance>,
    /// Required. Volume's name.
    pub name: Option<String>,
    /// Secret represents a secret that should populate this volume. More info: https://kubernetes.io/docs/concepts/storage/volumes#secret
    pub secret: Option<GoogleCloudRunOpV2SecretVolumeSource>,
}

impl client::Part for GoogleCloudRunOpV2Volume {}
...
/// 
#[derive(Default, Clone, Debug, Serialize, Deserialize)]
pub struct GoogleCloudRunOpV2VolumeMount {
...
impl client::Part for GoogleCloudRunOpV2VolumeMount {}
...
/// 
#[derive(Default, Clone, Debug, Serialize, Deserialize)]
pub struct GoogleCloudRunOpV2VpcAccess {
...
impl client::Part for GoogleCloudRunOpV2VpcAccess {}
...
impl<'a> ProjectMethods<'a> {
    ...
    pub fn locations_services_revisions_delete(&self, name: &str) -> ProjectLocationServiceRevisionDeleteCall<'a> {
    ...
    pub fn locations_services_revisions_get(&self, name: &str) -> ProjectLocationServiceRevisionGetCall<'a> {
    ...
    pub fn locations_services_revisions_list(&self, parent: &str) -> ProjectLocationServiceRevisionListCall<'a> {
    ...
    /// * `parent` - Required. The location and project in which this service should be created. Format: projects/{projectnumber}/locations/{location}
    pub fn locations_services_create(&self, request: GoogleCloudRunOpV2Service, parent: &str) -> ProjectLocationServiceCreateCall<'a> {
    ...
    /// # Arguments
    ///
    /// * `name` - Required. The full name of the Service. Format: projects/{projectnumber}/locations/{location}/services/{service}
    ...
    /// # Arguments
    ///
    /// * `parent` - Required. The location and project to list resources on. Location must be a valid GCP region, and may not be the "-" wildcard. Format: projects/{projectnumber}/locations/{location}
    ...
    pub fn locations_services_patch(&self, request: GoogleCloudRunOpV2Service, name: &str) -> ProjectLocationServicePatchCall<'a> {
    ...
    pub fn locations_services_set_iam_policy(&self, request: GoogleIamV1SetIamPolicyRequest, resource: &str) -> ProjectLocationServiceSetIamPolicyCall<'a> {
    ...
    pub fn locations_services_test_iam_permissions(&self, request: GoogleIamV1TestIamPermissionsRequest, resource: &str) -> ProjectLocationServiceTestIamPermissionCall<'a> {
...
impl<'a> ProjectLocationOperationDeleteCall<'a> {
    ...
    pub async fn doit(mut self) -> client::Result<(hyper::Response<hyper::body::Body>, GoogleProtobufEmpty)> {
        ...
        dlg.begin(client::MethodInfo { id: "run.projects.locations.operations.delete",
...
impl<'a> ProjectLocationOperationGetCall<'a> {
    ...
    pub async fn doit(mut self) -> client::Result<(hyper::Response<hyper::body::Body>, GoogleLongrunningOperation)> {
        ...
        dlg.begin(client::MethodInfo { id: "run.projects.locations.operations.get",
...
impl<'a> ProjectLocationOperationListCall<'a> {
    ...
    pub async fn doit(mut self) -> client::Result<(hyper::Response<hyper::body::Body>, GoogleLongrunningListOperationsResponse)> {
        ...
        dlg.begin(client::MethodInfo { id: "run.projects.locations.operations.list",
                               http_method: hyper::Method::GET });
...
/// Delete a Revision.
///
/// A builder for the *locations.services.revisions.delete* method supported by a *project* resource.
/// It is not used directly, but through a `ProjectMethods` instance.
///
/// # Example
///
...
/// // execute the final call using `doit()`.
/// // Values shown here are possibly random and not representative !
/// let result = hub.projects().locations_services_revisions_delete("name")
///              .validate_only(false)
///              .etag("ut")
///              .doit().await;
/// # }
/// ```
pub struct ProjectLocationServiceRevisionDeleteCall<'a>
    where  {
...
impl<'a> client::CallBuilder for ProjectLocationServiceRevisionDeleteCall<'a> {}

impl<'a> ProjectLocationServiceRevisionDeleteCall<'a> {
    ...
    pub async fn doit(mut self) -> client::Result<(hyper::Response<hyper::body::Body>, GoogleLongrunningOperation)> {
        ...
        dlg.begin(client::MethodInfo { id: "run.projects.locations.services.revisions.delete",
                               http_method: hyper::Method::DELETE });
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn name(mut self, new_value: &str) -> ProjectLocationServiceRevisionDeleteCall<'a> {
        self._name = new_value.to_string();
        self
    }
    ...
    pub fn validate_only(mut self, new_value: bool) -> ProjectLocationServiceRevisionDeleteCall<'a> {
    ...
    pub fn etag(mut self, new_value: &str) -> ProjectLocationServiceRevisionDeleteCall<'a> {
    ...
    ///
    /// Sets the *delegate* property to the given value.
    pub fn delegate(mut self, new_value: &'a mut dyn client::Delegate) -> ProjectLocationServiceRevisionDeleteCall<'a> {
        self._delegate = Some(new_value);
        self
    }
    ...
    /// * *uploadType* (query-string) - Legacy upload protocol for media (e.g. "media", "multipart").
    /// * *upload_protocol* (query-string) - Upload protocol for media (e.g. "raw", "multipart").
    pub fn param<T>(mut self, name: T, value: T) -> ProjectLocationServiceRevisionDeleteCall<'a>
                                                        where T: AsRef<str> {
        self._additional_params.insert(name.as_ref().to_string(), value.as_ref().to_string());
        self
    }
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<T, S>(mut self, scope: T) -> ProjectLocationServiceRevisionDeleteCall<'a>
                                                        where T: Into<Option<S>>,
                                                              S: AsRef<str> {
        match scope.into() {
          Some(scope) => self._scopes.insert(scope.as_ref().to_string(), ()),
...
/// Gets information about a Revision.
///
/// A builder for the *locations.services.revisions.get* method supported by a *project* resource.
/// It is not used directly, but through a `ProjectMethods` instance.
///
/// # Example
///
...
/// // execute the final call using `doit()`.
/// // Values shown here are possibly random and not representative !
/// let result = hub.projects().locations_services_revisions_get("name")
///              .doit().await;
/// # }
/// ```
pub struct ProjectLocationServiceRevisionGetCall<'a>
    where  {
...
impl<'a> client::CallBuilder for ProjectLocationServiceRevisionGetCall<'a> {}

impl<'a> ProjectLocationServiceRevisionGetCall<'a> {


    /// Perform the operation you have build so far.
    pub async fn doit(mut self) -> client::Result<(hyper::Response<hyper::body::Body>, GoogleCloudRunOpV2Revision)> {
        use url::percent_encoding::{percent_encode, DEFAULT_ENCODE_SET};
        use std::io::{Read, Seek};
        use hyper::header::{CONTENT_TYPE, CONTENT_LENGTH, AUTHORIZATION, USER_AGENT, LOCATION};
        use client::ToParts;
        ...
        dlg.begin(client::MethodInfo { id: "run.projects.locations.services.revisions.get",
                               http_method: hyper::Method::GET });
        let mut params: Vec<(&str, String)> = Vec::with_capacity(3 + self._additional_params.len());
        params.push(("name", self._name.to_string()));
        for &field in ["alt", "name"].iter() {
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn name(mut self, new_value: &str) -> ProjectLocationServiceRevisionGetCall<'a> {
        self._name = new_value.to_string();
        self
    }
    /// The delegate implementation is consulted whenever there is an intermediate result, or if something goes wrong
    ...
    ///
    /// Sets the *delegate* property to the given value.
    pub fn delegate(mut self, new_value: &'a mut dyn client::Delegate) -> ProjectLocationServiceRevisionGetCall<'a> {
        self._delegate = Some(new_value);
        self
    }
    ...
    /// * *uploadType* (query-string) - Legacy upload protocol for media (e.g. "media", "multipart").
    /// * *upload_protocol* (query-string) - Upload protocol for media (e.g. "raw", "multipart").
    pub fn param<T>(mut self, name: T, value: T) -> ProjectLocationServiceRevisionGetCall<'a>
                                                        where T: AsRef<str> {
        self._additional_params.insert(name.as_ref().to_string(), value.as_ref().to_string());
        self
    }
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<T, S>(mut self, scope: T) -> ProjectLocationServiceRevisionGetCall<'a>
                                                        where T: Into<Option<S>>,
                                                              S: AsRef<str> {
        match scope.into() {
          Some(scope) => self._scopes.insert(scope.as_ref().to_string(), ()),
...
/// List Revisions from a given Service, or from a given location.
///
/// A builder for the *locations.services.revisions.list* method supported by a *project* resource.
/// It is not used directly, but through a `ProjectMethods` instance.
///
/// # Example
///
...
/// // execute the final call using `doit()`.
/// // Values shown here are possibly random and not representative !
/// let result = hub.projects().locations_services_revisions_list("parent")
///              .show_deleted(true)
///              .page_token("ipsum")
///              .page_size(-50)
///              .doit().await;
/// # }
/// ```
pub struct ProjectLocationServiceRevisionListCall<'a>
    where  {
...
impl<'a> client::CallBuilder for ProjectLocationServiceRevisionListCall<'a> {}

impl<'a> ProjectLocationServiceRevisionListCall<'a> {


    /// Perform the operation you have build so far.
    pub async fn doit(mut self) -> client::Result<(hyper::Response<hyper::body::Body>, GoogleCloudRunOpV2ListRevisionsResponse)> {
        use url::percent_encoding::{percent_encode, DEFAULT_ENCODE_SET};
        use std::io::{Read, Seek};
        use hyper::header::{CONTENT_TYPE, CONTENT_LENGTH, AUTHORIZATION, USER_AGENT, LOCATION};
        use client::ToParts;
        ...
        dlg.begin(client::MethodInfo { id: "run.projects.locations.services.revisions.list",
                               http_method: hyper::Method::GET });
        let mut params: Vec<(&str, String)> = Vec::with_capacity(6 + self._additional_params.len());
        ...
        let mut url = self.hub._base_url.clone() + "v2/{+parent}/revisions";
        if self._scopes.len() == 0 {
            self._scopes.insert(Scope::CloudPlatform.as_ref().to_string(), ());
        }
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn parent(mut self, new_value: &str) -> ProjectLocationServiceRevisionListCall<'a> {
    ...
    pub fn show_deleted(mut self, new_value: bool) -> ProjectLocationServiceRevisionListCall<'a> {
    ...
    ///
    /// Sets the *page token* query property to the given value.
    pub fn page_token(mut self, new_value: &str) -> ProjectLocationServiceRevisionListCall<'a> {
        self._page_token = Some(new_value.to_string());
        self
    }
    ...
    ///
    /// Sets the *page size* query property to the given value.
    pub fn page_size(mut self, new_value: i32) -> ProjectLocationServiceRevisionListCall<'a> {
        self._page_size = Some(new_value);
        self
    }
    /// The delegate implementation is consulted whenever there is an intermediate result, or if something goes wrong
    ...
    ///
    /// Sets the *delegate* property to the given value.
    pub fn delegate(mut self, new_value: &'a mut dyn client::Delegate) -> ProjectLocationServiceRevisionListCall<'a> {
        self._delegate = Some(new_value);
        self
    }
    ...
    /// * *uploadType* (query-string) - Legacy upload protocol for media (e.g. "media", "multipart").
    /// * *upload_protocol* (query-string) - Upload protocol for media (e.g. "raw", "multipart").
    pub fn param<T>(mut self, name: T, value: T) -> ProjectLocationServiceRevisionListCall<'a>
                                                        where T: AsRef<str> {
        self._additional_params.insert(name.as_ref().to_string(), value.as_ref().to_string());
        self
    }
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<T, S>(mut self, scope: T) -> ProjectLocationServiceRevisionListCall<'a>
                                                        where T: Into<Option<S>>,
                                                              S: AsRef<str> {
        match scope.into() {
          Some(scope) => self._scopes.insert(scope.as_ref().to_string(), ()),
...
pub struct ProjectLocationServiceCreateCall<'a>
    ...
    hub: &'a CloudRun<>,
    _request: GoogleCloudRunOpV2Service,
    _parent: String,
    _validate_only: Option<bool>,
...
impl<'a> ProjectLocationServiceCreateCall<'a> {
    ...
    pub async fn doit(mut self) -> client::Result<(hyper::Response<hyper::body::Body>, GoogleLongrunningOperation)> {
        ...
        for &field in ["alt", "parent", "validateOnly", "serviceId"].iter() {
            if self._additional_params.contains_key(field) {
                dlg.finished(false);
                return Err(client::Error::FieldClash(field));
            }
        ...
        let mut url = self.hub._base_url.clone() + "v2/{+parent}/services";
        if self._scopes.len() == 0 {
            self._scopes.insert(Scope::CloudPlatform.as_ref().to_string(), ());
        }
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn request(mut self, new_value: GoogleCloudRunOpV2Service) -> ProjectLocationServiceCreateCall<'a> {
    ...
    ///
    /// Sets the *validate only* query property to the given value.
    pub fn validate_only(mut self, new_value: bool) -> ProjectLocationServiceCreateCall<'a> {
        self._validate_only = Some(new_value);
        self
    }
...
impl<'a> ProjectLocationServiceDeleteCall<'a> {
    ...
    ///
    /// Sets the *validate only* query property to the given value.
    pub fn validate_only(mut self, new_value: bool) -> ProjectLocationServiceDeleteCall<'a> {
        self._validate_only = Some(new_value);
        self
    }
    ...
    ///
    /// Sets the *etag* query property to the given value.
    pub fn etag(mut self, new_value: &str) -> ProjectLocationServiceDeleteCall<'a> {
        self._etag = Some(new_value.to_string());
        self
    }
    /// The delegate implementation is consulted whenever there is an intermediate result, or if something goes wrong
...
impl<'a> ProjectLocationServiceGetCall<'a> {
    ...
    /// Perform the operation you have build so far.
    pub async fn doit(mut self) -> client::Result<(hyper::Response<hyper::body::Body>, GoogleCloudRunOpV2Service)> {
        use url::percent_encoding::{percent_encode, DEFAULT_ENCODE_SET};
        use std::io::{Read, Seek};
        use hyper::header::{CONTENT_TYPE, CONTENT_LENGTH, AUTHORIZATION, USER_AGENT, LOCATION};
        use client::ToParts;
...
impl<'a> ProjectLocationServiceListCall<'a> {
    ...
    /// Perform the operation you have build so far.
    pub async fn doit(mut self) -> client::Result<(hyper::Response<hyper::body::Body>, GoogleCloudRunOpV2ListServicesResponse)> {
        use url::percent_encoding::{percent_encode, DEFAULT_ENCODE_SET};
        use std::io::{Read, Seek};
        use hyper::header::{CONTENT_TYPE, CONTENT_LENGTH, AUTHORIZATION, USER_AGENT, LOCATION};
        use client::ToParts;
    ...
    ///
    /// Sets the *show deleted* query property to the given value.
    pub fn show_deleted(mut self, new_value: bool) -> ProjectLocationServiceListCall<'a> {
        self._show_deleted = Some(new_value);
        self
    }
...
impl<'a> ProjectLocationServicePatchCall<'a> {
    ...
    pub async fn doit(mut self) -> client::Result<(hyper::Response<hyper::body::Body>, GoogleLongrunningOperation)> {
        ...
        dlg.begin(client::MethodInfo { id: "run.projects.locations.services.patch",
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn request(mut self, new_value: GoogleCloudRunOpV2Service) -> ProjectLocationServicePatchCall<'a> {
        self._request = new_value;
        self
    }
    /// The fully qualified name of this Service. In CreateServiceRequest, this field is ignored, and instead composed from CreateServiceRequest.parent and CreateServiceRequest.service_id. Format: projects/{project}/locations/{location}/services/{service_id}
    ...
    ///
    /// Sets the *validate only* query property to the given value.
    pub fn validate_only(mut self, new_value: bool) -> ProjectLocationServicePatchCall<'a> {
        self._validate_only = Some(new_value);
        self
    }
    ...
    pub fn allow_missing(mut self, new_value: bool) -> ProjectLocationServicePatchCall<'a> {
...
/// # extern crate hyper_rustls;
/// # extern crate google_run2 as run2;
/// use run2::api::GoogleIamV1SetIamPolicyRequest;
/// # async fn dox() {
/// # use std::default::Default;
/// # use run2::{CloudRun, oauth2, hyper, hyper_rustls};
/// 
...
impl<'a> ProjectLocationServiceSetIamPolicyCall<'a> {
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn request(mut self, new_value: GoogleIamV1SetIamPolicyRequest) -> ProjectLocationServiceSetIamPolicyCall<'a> {
        self._request = new_value;
        self
    }
...
/// # extern crate hyper_rustls;
/// # extern crate google_run2 as run2;
/// use run2::api::GoogleIamV1TestIamPermissionsRequest;
/// # async fn dox() {
/// # use std::default::Default;
/// # use run2::{CloudRun, oauth2, hyper, hyper_rustls};
/// 
...
impl<'a> ProjectLocationServiceTestIamPermissionCall<'a> {
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn request(mut self, new_value: GoogleIamV1TestIamPermissionsRequest) -> ProjectLocationServiceTestIamPermissionCall<'a> {
        self._request = new_value;
        self
    }
