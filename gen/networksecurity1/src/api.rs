...
impl<'a> ProjectLocationAuthorizationPolicyCreateCall<'a> {
    ...
    pub async fn doit(mut self) -> client::Result<(hyper::Response<hyper::body::Body>, Operation)> {
        ...
        if let Some(value) = self._authorization_policy_id {
            params.push(("authorizationPolicyId", value.to_string()));
        }
...
impl<'a> ProjectLocationClientTlsPolicyCreateCall<'a> {
    ...
    pub async fn doit(mut self) -> client::Result<(hyper::Response<hyper::body::Body>, Operation)> {
        ...
        let mut params: Vec<(&str, String)> = Vec::with_capacity(5 + self._additional_params.len());
        params.push(("parent", self._parent.to_string()));
        if let Some(value) = self._client_tls_policy_id {
            params.push(("clientTlsPolicyId", value.to_string()));
        }
...
impl<'a> ProjectLocationServerTlsPolicyCreateCall<'a> {
    ...
    pub async fn doit(mut self) -> client::Result<(hyper::Response<hyper::body::Body>, Operation)> {
        ...
        let mut params: Vec<(&str, String)> = Vec::with_capacity(5 + self._additional_params.len());
        params.push(("parent", self._parent.to_string()));
        if let Some(value) = self._server_tls_policy_id {
            params.push(("serverTlsPolicyId", value.to_string()));
        }
