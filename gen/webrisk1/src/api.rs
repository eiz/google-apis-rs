...
/// Central instance to access all WebRisk related resource activities
///
/// # Examples
///
...
impl<'a, > WebRisk<> {
    ...
    /// It defaults to `https://webrisk.googleapis.com/`.
    ///
...
/// The list links the activity name, along with information about where it is used (one of *request* and *response*).
/// 
/// * [search hashes](HasheSearchCall) (response)
/// 
#[derive(Default, Clone, Debug, Serialize, Deserialize)]
...
/// A builder providing access to all methods supported on *hashe* resources.
...
/// Gets the full hashes that match the requested hash prefix. This is used after a hash prefix is looked up in a threatList and there is a match. The client side threatList only holds partial hashes so the client must query this method to determine if there is a full hash match of a threat.
///
/// A builder for the *search* method supported by a *hashe* resource.
/// It is not used directly, but through a `HasheMethods` instance.
///
/// # Example
///
...
impl<'a> HasheSearchCall<'a> {
    ...
    pub async fn doit(mut self) -> client::Result<(hyper::Response<hyper::body::Body>, GoogleCloudWebriskV1SearchHashesResponse)> {
        ...
        dlg.begin(client::MethodInfo { id: "webrisk.hashes.search",
                               http_method: hyper::Method::GET });
        let mut params: Vec<(&str, String)> = Vec::with_capacity(4 + self._additional_params.len());
        if self._threat_types.len() > 0 {
            for f in self._threat_types.iter() {
                params.push(("threatTypes", f.to_string()));
            }
        }
        if let Some(value) = self._hash_prefix {
            params.push(("hashPrefix", value.to_string()));
        }
        for &field in ["alt", "threatTypes", "hashPrefix"].iter() {
        ...
        let mut url = self.hub._base_url.clone() + "v1/hashes:search";
...
impl<'a> ProjectOperationCancelCall<'a> {
    ...
    pub async fn doit(mut self) -> client::Result<(hyper::Response<hyper::body::Body>, GoogleProtobufEmpty)> {
        ...
        dlg.begin(client::MethodInfo { id: "webrisk.projects.operations.cancel",
...
impl<'a> ProjectOperationDeleteCall<'a> {
    ...
    pub async fn doit(mut self) -> client::Result<(hyper::Response<hyper::body::Body>, GoogleProtobufEmpty)> {
        ...
        dlg.begin(client::MethodInfo { id: "webrisk.projects.operations.delete",
...
impl<'a> ProjectOperationGetCall<'a> {
    ...
    pub async fn doit(mut self) -> client::Result<(hyper::Response<hyper::body::Body>, GoogleLongrunningOperation)> {
        ...
        dlg.begin(client::MethodInfo { id: "webrisk.projects.operations.get",
                               http_method: hyper::Method::GET });
        let mut params: Vec<(&str, String)> = Vec::with_capacity(3 + self._additional_params.len());
        params.push(("name", self._name.to_string()));
        for &field in ["alt", "name"].iter() {
...
impl<'a> ProjectOperationListCall<'a> {
    ...
    pub async fn doit(mut self) -> client::Result<(hyper::Response<hyper::body::Body>, GoogleLongrunningListOperationsResponse)> {
        ...
        dlg.begin(client::MethodInfo { id: "webrisk.projects.operations.list",
                               http_method: hyper::Method::GET });
...
/// Creates a Submission of a URI suspected of containing phishing content to be reviewed. If the result verifies the existence of malicious phishing content, the site will be added to the [Google's Social Engineering lists](https://support.google.com/webmasters/answer/6350487/) in order to protect users that could get exposed to this threat in the future. Only allowlisted projects can use this method during Early Access. Please reach out to Sales or your customer engineer to obtain access.
///
/// A builder for the *submissions.create* method supported by a *project* resource.
/// It is not used directly, but through a `ProjectMethods` instance.
///
/// # Example
///
...
/// # extern crate hyper_rustls;
/// # extern crate google_webrisk1 as webrisk1;
/// use webrisk1::api::GoogleCloudWebriskV1Submission;
/// # async fn dox() {
/// # use std::default::Default;
/// # use webrisk1::{WebRisk, oauth2, hyper, hyper_rustls};
/// 
...
/// // into the respective structure. Some of the parts shown here might not be applicable !
/// // Values shown here are possibly random and not representative !
/// let mut req = GoogleCloudWebriskV1Submission::default();
/// 
/// // You can configure optional parameters by calling the respective setters at will, and
/// // execute the final call using `doit()`.
/// // Values shown here are possibly random and not representative !
/// let result = hub.projects().submissions_create(req, "parent")
///              .doit().await;
/// # }
/// ```
...
impl<'a> ProjectSubmissionCreateCall<'a> {
    ...
    /// Perform the operation you have build so far.
    pub async fn doit(mut self) -> client::Result<(hyper::Response<hyper::body::Body>, GoogleCloudWebriskV1Submission)> {
        use url::percent_encoding::{percent_encode, DEFAULT_ENCODE_SET};
        use std::io::{Read, Seek};
        use hyper::header::{CONTENT_TYPE, CONTENT_LENGTH, AUTHORIZATION, USER_AGENT, LOCATION};
        use client::ToParts;
        ...
        dlg.begin(client::MethodInfo { id: "webrisk.projects.submissions.create",
                               http_method: hyper::Method::POST });
        let mut params: Vec<(&str, String)> = Vec::with_capacity(4 + self._additional_params.len());
        ...
        let mut url = self.hub._base_url.clone() + "v1/{+parent}/submissions";
        if self._scopes.len() == 0 {
            self._scopes.insert(Scope::CloudPlatform.as_ref().to_string(), ());
        }
...
pub struct ThreatListComputeDiffCall<'a>
    ...
    _constraints_max_diff_entries: Option<i32>,
    _constraints_max_database_entries: Option<i32>,
    _delegate: Option<&'a mut dyn client::Delegate>,
    _additional_params: HashMap<String, String>,
    _scopes: BTreeMap<String, ()>
}
...
impl<'a> ThreatListComputeDiffCall<'a> {
    ...
    /// Perform the operation you have build so far.
    pub async fn doit(mut self) -> client::Result<(hyper::Response<hyper::body::Body>, GoogleCloudWebriskV1ComputeThreatListDiffResponse)> {
        use std::io::{Read, Seek};
        use hyper::header::{CONTENT_TYPE, CONTENT_LENGTH, AUTHORIZATION, USER_AGENT, LOCATION};
        use client::ToParts;
        let mut dd = client::DefaultDelegate;
        ...
        dlg.begin(client::MethodInfo { id: "webrisk.threatLists.computeDiff",
                               http_method: hyper::Method::GET });
        let mut params: Vec<(&str, String)> = Vec::with_capacity(7 + self._additional_params.len());
        if let Some(value) = self._version_token {
            params.push(("versionToken", value.to_string()));
        }
        if let Some(value) = self._threat_type {
            params.push(("threatType", value.to_string()));
        }
        if self._constraints_supported_compressions.len() > 0 {
            for f in self._constraints_supported_compressions.iter() {
                params.push(("constraints.supportedCompressions", f.to_string()));
            }
        }
        if let Some(value) = self._constraints_max_diff_entries {
            params.push(("constraints.maxDiffEntries", value.to_string()));
        }
        if let Some(value) = self._constraints_max_database_entries {
            params.push(("constraints.maxDatabaseEntries", value.to_string()));
        }
        for &field in ["alt", "versionToken", "threatType", "constraints.supportedCompressions", "constraints.maxDiffEntries", "constraints.maxDatabaseEntries"].iter() {
            if self._additional_params.contains_key(field) {
                dlg.finished(false);
                return Err(client::Error::FieldClash(field));
            }
        ...
        let mut url = self.hub._base_url.clone() + "v1/threatLists:computeDiff";
        if self._scopes.len() == 0 {
            self._scopes.insert(Scope::CloudPlatform.as_ref().to_string(), ());
        }
...
/// This method is used to check whether a URI is on a given threatList. Multiple threatLists may be searched in a single query. The response will list all requested threatLists the URI was found to match. If the URI is not found on any of the requested ThreatList an empty response will be returned.
///
/// A builder for the *search* method supported by a *uri* resource.
/// It is not used directly, but through a `UriMethods` instance.
///
/// # Example
///
/// Instantiate a resource method builder
...
impl<'a> UriSearchCall<'a> {
    ...
    /// Perform the operation you have build so far.
    pub async fn doit(mut self) -> client::Result<(hyper::Response<hyper::body::Body>, GoogleCloudWebriskV1SearchUrisResponse)> {
        use std::io::{Read, Seek};
        use hyper::header::{CONTENT_TYPE, CONTENT_LENGTH, AUTHORIZATION, USER_AGENT, LOCATION};
        use client::ToParts;
        let mut dd = client::DefaultDelegate;
        ...
        dlg.begin(client::MethodInfo { id: "webrisk.uris.search",
                               http_method: hyper::Method::GET });
        let mut params: Vec<(&str, String)> = Vec::with_capacity(4 + self._additional_params.len());
        ...
        for &field in ["alt", "uri", "threatTypes"].iter() {
            if self._additional_params.contains_key(field) {
                dlg.finished(false);
                return Err(client::Error::FieldClash(field));
            }
        ...
        let mut url = self.hub._base_url.clone() + "v1/uris:search";
        if self._scopes.len() == 0 {
            self._scopes.insert(Scope::CloudPlatform.as_ref().to_string(), ());
        }
