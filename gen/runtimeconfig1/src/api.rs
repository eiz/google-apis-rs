...
/// # extern crate hyper_rustls;
/// # extern crate google_runtimeconfig1 as runtimeconfig1;
/// use runtimeconfig1::api::CancelOperationRequest;
/// # async fn dox() {
/// # use std::default::Default;
/// # use runtimeconfig1::{CloudRuntimeConfig, oauth2, hyper, hyper_rustls};
/// 
...
impl<'a> OperationCancelCall<'a> {
    ...
    pub async fn doit(mut self) -> client::Result<(hyper::Response<hyper::body::Body>, Empty)> {
        ...
        dlg.begin(client::MethodInfo { id: "runtimeconfig.operations.cancel",
...
impl<'a> OperationDeleteCall<'a> {
    ...
    pub async fn doit(mut self) -> client::Result<(hyper::Response<hyper::body::Body>, Empty)> {
        ...
        dlg.begin(client::MethodInfo { id: "runtimeconfig.operations.delete",
...
impl<'a> OperationListCall<'a> {
    ...
    pub async fn doit(mut self) -> client::Result<(hyper::Response<hyper::body::Body>, ListOperationsResponse)> {
        ...
        dlg.begin(client::MethodInfo { id: "runtimeconfig.operations.list",
